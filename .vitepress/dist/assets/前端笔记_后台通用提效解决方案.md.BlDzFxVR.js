import{_ as s,c as a,o as n,a3 as i}from"./chunks/framework.COm4hYgr.js";const u=JSON.parse('{"title":"后台通用提效解决方案","description":"","frontmatter":{},"headers":[],"relativePath":"前端笔记/后台通用提效解决方案.md","filePath":"前端笔记/后台通用提效解决方案.md"}'),p={name:"前端笔记/后台通用提效解决方案.md"},t=i(`<h1 id="后台通用提效解决方案" tabindex="-1">后台通用提效解决方案 <a class="header-anchor" href="#后台通用提效解决方案" aria-label="Permalink to &quot;后台通用提效解决方案&quot;">​</a></h1><h2 id="编程规范" tabindex="-1">编程规范 <a class="header-anchor" href="#编程规范" aria-label="Permalink to &quot;编程规范&quot;">​</a></h2><h3 id="git-提交格式" tabindex="-1">git 提交格式 <a class="header-anchor" href="#git-提交格式" aria-label="Permalink to &quot;git 提交格式&quot;">​</a></h3><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">module</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">exports</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
