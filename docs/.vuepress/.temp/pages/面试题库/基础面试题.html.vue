<template><div><h1 id="前端面试题库" tabindex="-1"><a class="header-anchor" href="#前端面试题库" aria-hidden="true">#</a> 前端面试题库</h1>
<div class="custom-container tip">
<p class="custom-container-title">Tips</p>
<p>本文档是学习时的记录，仅作为笔记回顾已学习知识。</p>
</div>
<h2 id="浏览器" tabindex="-1"><a class="header-anchor" href="#浏览器" aria-hidden="true">#</a> 浏览器：</h2>
<h3 id="http-协议类" tabindex="-1"><a class="header-anchor" href="#http-协议类" aria-hidden="true">#</a> HTTP 协议类</h3>
<h4 id="http-协议的主要特点" tabindex="-1"><a class="header-anchor" href="#http-协议的主要特点" aria-hidden="true">#</a> HTTP 协议的主要特点?</h4>
<ol>
<li>
<p>简单快速 (每个资源都是固定的 URI)</p>
</li>
<li>
<p>灵活 (通过一个 HTTP 协议可以完成不同数据类型的传输)</p>
</li>
<li>
<p><strong>无连接 (连接一次断掉 , 不会一直连接)</strong></p>
</li>
<li>
<p><strong>无状态 (客服端和服务端是两种身份，一次连接后就断开，下次再连接，服务端无法区分两次是否由同一客户端发起的请求)</strong></p>
</li>
</ol>
<h4 id="http-报文的组成部分" tabindex="-1"><a class="header-anchor" href="#http-报文的组成部分" aria-hidden="true">#</a> HTTP 报文的组成部分?</h4>
<p><strong>由请求报文和响应报文组成:</strong></p>
<ol>
<li>
<p>请求报文：请求行、请求头、空行、请求体</p>
<ul>
<li>请求行包含：页面地址、http 方法、协议以及版本 (<code v-pre>GET</code> / <code v-pre>HTTP1.1</code>)</li>
<li>请求头：就是一些 key\value 值 , <strong>告诉服务端我要什么内容</strong> , 和要注意什么类型</li>
<li>空行：遇到空行就能知道 下面不是请求头的部分了</li>
<li>请求体：数据</li>
</ul>
</li>
<li>
<p>响应报文：状态行，响应头、空行、响应体</p>
<ul>
<li>状态行: HTTP 协议、状态码 (<code v-pre>HTTP1.1</code>/ <code v-pre>200</code> ok)</li>
<li>其它都是与请求报文大同小异的</li>
</ul>
</li>
</ol>
<h4 id="http-方法有哪些" tabindex="-1"><a class="header-anchor" href="#http-方法有哪些" aria-hidden="true">#</a> HTTP 方法有哪些?</h4>
<ul>
<li>GET---------获取资源</li>
<li>POST-------传输资源</li>
<li>PUT---------更新资源</li>
...
<h4 id="get-请求和-post-请求的区别是什么-主要作用在哪" tabindex="-1"><a class="header-anchor" href="#get-请求和-post-请求的区别是什么-主要作用在哪" aria-hidden="true">#</a> Get 请求和 Post 请求的区别是什么?主要作用在哪?</h4>
<ol>
<li><code v-pre>get</code>点击浏览器回退按钮<strong>不会再次提交</strong> , <code v-pre>post</code><strong>会再次提交请求</strong></li>
<li><code v-pre>get</code>请求会被浏览器主动<strong>缓存</strong> , <code v-pre>post</code>不会 (除非手动设置)</li>
<li><code v-pre>get</code>的参数可以保留在浏览器<strong>历史记录</strong> , <code v-pre>post</code>不会</li>
<li><code v-pre>get</code>产生的 URL 地址可以被<strong>收藏</strong>，<code v-pre>post</code>不可以</li>
<li><code v-pre>get</code>参数通过 url 传递 ，是<strong>明文显示</strong>的, 不能用来传敏感信息 , <code v-pre>post</code>通过<code v-pre>Request body</code>, <code v-pre>post</code>相对更安全</li>
<li><code v-pre>get</code>传送参数<strong>长度</strong>是有限制的(2kb) , <code v-pre>post</code>无限制（浏览器规定的长度）</li>
<li><code v-pre>post</code> 支持更多的<strong>编码类型</strong>, 且不对数据类型限制</li>
</ol>
<h4 id="http首部" tabindex="-1"><a class="header-anchor" href="#http首部" aria-hidden="true">#</a> http首部</h4>
<p>首部分为请求首部和响应首部，并且部分首部两种通用。</p>
<p><strong>通用首部</strong>
<img src="https://gitee.com/l544402029/res/raw/master/小书匠/1621410618962.png" alt="通用首部"></p>
<p><strong>请求首部</strong>
<img src="https://gitee.com/l544402029/res/raw/master/小书匠/1621410593330.png" alt="请求首部"></p>
<p><strong>响应首部</strong>
<img src="https://gitee.com/l544402029/res/raw/master/小书匠/1621410659764.png" alt="响应首部"></p>
<p><strong>实体首部</strong>
<img src="https://gitee.com/l544402029/res/raw/master/小书匠/1621410695691.png" alt="实体首部"></p>
<h4 id="什么是持久链接" tabindex="-1"><a class="header-anchor" href="#什么是持久链接" aria-hidden="true">#</a> 什么是持久链接?</h4>
<p>持久连接 <code v-pre>Keep-alive</code></p>
<p>非<code v-pre>Keep-ailve</code>模式时，每个请求/应答客户端和服务器都要新建一个连接，完成后就断开</p>
<p>当<code v-pre>Keep-ailve</code>模式（又称持久连接、连接重用）时，客户端到服务器端的<strong>连接持续有效</strong>，避免后续请求时，重新建立连接。
并且必须是<strong>http1.1</strong>版本才支持持久连接。</p>
<h4 id="什么是管线化" tabindex="-1"><a class="header-anchor" href="#什么是管线化" aria-hidden="true">#</a> 什么是管线化?</h4>
<ul>
<li><strong>GET</strong> 和 <strong>HEAD</strong> 可以管线化 ， <strong>POST 是有所限制</strong></li>
<li>初次创建连接时不应该启动管线机制， 因为对方（服务器）不一定支持 HTTP/1.1 版本的协议</li>
</ul>
<p>持久连接：请求 1 -》响应 1-》请求 2-》响应 2-》请求 3 -》响应 3</p>
<p>管线化：请求 1-》请求 2-》请求 3-》响应 1-》响应 2-》响应 3 把现在的请求一次打包传输过去，响应也是一次性返回过来，并且是在持久连接的情况下完成的， 管线化是通过持久连接完成，仅 HTTP/1.1 支持此技术。</p>
<h4 id="http-与-https-的区别" tabindex="-1"><a class="header-anchor" href="#http-与-https-的区别" aria-hidden="true">#</a> HTTP 与 HTTPS 的区别？</h4>
<ul>
<li>
<p>HTTP 协议通常<strong>承载于 TCP 协议</strong>之上，在 HTTP 和 TCP 之间添加一个<strong>安全协议层</strong>（SSL 或 TLS），就成了我们常说的 HTTPS。</p>
</li>
<li>
<p>默认 HTTP 的端口号为<code v-pre>80</code>，HTTPS 的端口号为<code v-pre>443</code>。</p>
</li>
</ul>
<h4 id="为什么-https-安全" tabindex="-1"><a class="header-anchor" href="#为什么-https-安全" aria-hidden="true">#</a> 为什么 HTTPS 安全？</h4>
<p>因为网络请求需要中间有很多的<strong>服务器路由器的转发</strong>。中间的节点很有可能篡改信息，而如果使用 HTTPS，密钥在你和终点站才有。 https 之所以比 http 安全，是因为他利用了 <code v-pre>ssl/tls</code> 协议传输。它包含证书，卸载，流量转发，负载均衡，页面适配，浏览器适配，<code v-pre>refer</code> 传递等。保障了传输过程的安全性。</p>
<h4 id="简述三次握手是什么" tabindex="-1"><a class="header-anchor" href="#简述三次握手是什么" aria-hidden="true">#</a> 简述三次握手是什么？</h4>
<p>HTTP 协议是使用 TCP 协议作为其传输层协议的，在拿到服务器的 IP 地址后，浏览器客户端会与服务器建立 TCP 连接。该过程包括三次握手：</p>
<ol>
<li>建立连接时，客户端向服务器<strong>发送请求报文</strong></li>
<li>服务器收到请求报文后，<strong>如同意连接</strong>，则向客户端<strong>发送确认报文</strong></li>
<li>客户端收到服务器的确认后，<strong>再次向服务器发出确认报文</strong>，完成连接。</li>
</ol>
<p>三次握手主要是为了防止已经失效的请求报文字段发送给服务器，浪费资源。</p>
<h4 id="简述四次挥手是什么" tabindex="-1"><a class="header-anchor" href="#简述四次挥手是什么" aria-hidden="true">#</a> 简述四次挥手是什么？</h4>
<ol>
<li>客户端<strong>想断开连接</strong>，发送消息给服务器</li>
<li>服务器通知客户端已经接收到断开连接请求，但<strong>还没做好断开连接准备</strong></li>
<li>服务器已经<strong>做好断开连接准备</strong>，通知客户端</li>
<li>客户端<strong>发送消息</strong>给服务器，<strong>确定断开连接</strong>，服务器关闭连接</li>
</ol>
<h4 id="为什么-tcp-建立连接需要三次握手-明明两次就可以建立起连接" tabindex="-1"><a class="header-anchor" href="#为什么-tcp-建立连接需要三次握手-明明两次就可以建立起连接" aria-hidden="true">#</a> 为什么 TCP 建立连接需要三次握手，明明两次就可以建立起连接?</h4>
<p>为了防止出现失效的连接请求报文段被服务端接收的情况，从而产生错误。</p>
<p>可以想象如下场景。客户端发送了一个连接请求 A，但是因为网络原因造成了超时，这时 TCP 会启动超时重传的机制再次发送一个连接请求 B。此时请求顺利到达服务端，服务端应答完就建立了请求，然后接收数据后释放了连接。
假设这时候连接请求 A 在两端关闭后终于抵达了服务端，那么此时服务端会认为客户端又需要建立 TCP 连接，从而应答了该请求并进入 ESTABLISHED(建立了) 状态。但是客户端其实是 CLOSED（关闭） 的状态，那么就会导致服务端一直等待，造成资源的浪费。</p>
<h4 id="contenttype-有哪几种类型" tabindex="-1"><a class="header-anchor" href="#contenttype-有哪几种类型" aria-hidden="true">#</a> contenttype 有哪几种类型?</h4>
<ol>
<li>
<p><code v-pre>application/json</code></p>
</li>
<li>
<p><code v-pre>text/xml</code></p>
</li>
<li>
<p><code v-pre>multipart/form-data</code></p>
</li>
<li>
<p><code v-pre>application/x-www-form-urlencoded</code></p>
</li>
</ol>
<h4 id="如何保持登录状态" tabindex="-1"><a class="header-anchor" href="#如何保持登录状态" aria-hidden="true">#</a> 如何保持登录状态？</h4>
<ul>
<li><code v-pre>cookie</code>+<code v-pre>session</code></li>
</ul>
<p><code v-pre>cookie</code>的特点：<code v-pre>cookie</code>会伴随每次请求，在浏览器和服务器之间来回传递；</p>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/cookie.png" alt="web端状态保持原理图"></p>
<ul>
<li><code v-pre>token</code> 令牌机制</li>
</ul>
<p>非 web 端，没有 <code v-pre>cookie</code> ，因此不能用 <code v-pre>cookie</code> + <code v-pre>sessionid</code> 这种机制实现状态保持。
但是我们可以借鉴这个实现思路，自己模拟 <code v-pre>cookie</code> 和 <code v-pre>session</code> 的机制，<code v-pre>token</code>机制（令牌机制）。</p>
<h4 id="readystate-状态码" tabindex="-1"><a class="header-anchor" href="#readystate-状态码" aria-hidden="true">#</a> readyState 状态码</h4>
<ul>
<li>
<p>0 - 未初始化 , 还<strong>没有</strong>调用<code v-pre>send</code>方法</p>
</li>
<li>
<p>1 - 载入 <strong>已调用</strong><code v-pre>send</code>方法,<strong>正在发送请求</strong></p>
</li>
<li>
<p>2 - 载入完成 <code v-pre>send</code>方法<strong>执行完成</strong> , 已<strong>接收到全部</strong>响应内容</p>
</li>
<li>
<p>3 - 交互 正在<strong>解析</strong>响应内容</p>
</li>
<li>
<p>4 - 完成 <strong>响应内容解析完成</strong> , 可以在客户端<strong>调用</strong></p>
</li>
</ul>
<h4 id="status-状态码" tabindex="-1"><a class="header-anchor" href="#status-状态码" aria-hidden="true">#</a> status 状态码</h4>
<ul>
<li>
<p>1xx 指示信息</p>
<ul>
...
<p>2xx 表示成功处理请求</p>
<ul>
<li><code v-pre>200</code>表示客户端请求成功</li>
<li><code v-pre>206</code>表示范围请求（视频，音频文件很大的时候，基本返回的都是 206）</li>
</ul>
</li>
<li>
<p>3xx 重定向</p>
<ul>
<li><code v-pre>301</code>永久重定向，被分配新的 url</li>
<li><code v-pre>302</code>临时重定向，临时分配新 url</li>
<li><code v-pre>304</code>表示使用缓存</li>
</ul>
</li>
<li>
<p>4xx 客户端请求错误</p>
<ul>
<li><code v-pre>400</code>语法错误，不能被服务器所理解</li>
<li><code v-pre>401</code>请求未经授权</li>
<li><code v-pre>403</code>请求页面的访问被禁止</li>
<li><code v-pre>404</code>请求资源不存在</li>
</ul>
</li>
<li>
<p>5xx 服务器端错误</p>
<ul>
<li><code v-pre>500</code>服务器执行请求发生错误</li>
<li><code v-pre>501</code>服务器不支持当前请求所需的某个功能</li>
<li><code v-pre>503</code>服务器过载或宕机</li>
</ul>
</li>
</ul>
<h4 id="udp-与-tcp-的区别是什么" tabindex="-1"><a class="header-anchor" href="#udp-与-tcp-的区别是什么" aria-hidden="true">#</a> UDP 与 TCP 的区别是什么？</h4>
...
<p><strong>面向无连接</strong>
首先 UDP 是不需要和 TCP 一样在发送数据前进行三次握手建立连接的，想发数据就可以开始发送了。</p>
...
<p><strong>高效</strong>
虽然 UDP 协议不是那么的可靠，但是正是因为它不是那么的可靠，所以也就没有 TCP 那么复杂了，需要保证数据不丢失且有序到达。</p>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1621245018759.png" alt="enter description here"></p>
...
<ul>
<li>直播
想必大家都看过直播吧，大家可以考虑下如果直播使用了基于 TCP 的协议会发生什么事情？</li>
</ul>
...
<ul>
<li>王者荣耀
虽然不知道王者荣耀底层使用了什么协议，但是对于这类实时性要求很高的游戏来说，UDP 是跑不了的。</li>
</ul>
...
<ul>
<li>UDP 相比 TCP 更加简单，不需要<strong>建立连接</strong>，不需要<strong>验证数据报文</strong>，不需要<strong>流量控制</strong>，只会把想发的数据报文一股脑的丢给对端</li>
<li>UDP 并没有 TCP 传输来的<strong>准确</strong>，但是能在很多实时性要求高的地方有所作为（直播，王者荣耀）</li>
</ul>
...
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1621303212692.png" alt="头部"></p>
...
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1621304194808.png" alt="握手"></p>
<p>在这之前需要了解一个重要的性能指标 RTT。该指标表示发送端发送数据到接收到对端数据所需的往返时间。</p>
<p><strong>建立连接三次握手</strong></p>
...
<h4 id="为什么-tcp-建立连接需要三次握手-明明两次就可以建立起连接-1" tabindex="-1"><a class="header-anchor" href="#为什么-tcp-建立连接需要三次握手-明明两次就可以建立起连接-1" aria-hidden="true">#</a> 为什么 TCP 建立连接需要三次握手，明明两次就可以建立起连接？</h4>
...
<p><strong>断开链接四次握手</strong></p>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1621305387092.png" alt="四次挥手"></p>
...
<p><strong>ARQ 协议</strong>
ARQ 协议也就是超时重传机制。通过确认和超时机制保证了数据的正确送达，ARQ 协议包含停止等待 ARQ 和连续 ARQ 两种协议。</p>
<p><strong>停止等待 ARQ</strong></p>
<ul>
<li>正常传输过程</li>
</ul>
...
<p><strong>连续 ARQ</strong></p>
<p>在连续 ARQ 中，发送端拥有一个<strong>发送窗口</strong>，可以在没有收到应答的情况下持续发送窗口内的数据，这样相比停止等待 ARQ 协议来说减少了等待时间，提高了效率。</p>
<ul>
<li>累计确认
连续 ARQ 中，接收端会持续不断收到报文。如果和停止等待 ARQ 中接收一个报文就发送一个应答一样，就太浪费资源了。通过累计确认，可以在收到多个报文以后统一回复一个应答报文。报文中的 ACK 标志位可以用来告诉发送端这个序号之前的数据已经全部接收到了，下次请发送这个序号后的数据。</li>
</ul>
...
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1621306800248.png" alt="enter description here"></p>
<p>发送端窗口是由接收窗口剩余大小决定的。接收方会把当前接收窗口的剩余大小写入应答报文，发送端收到应答后根据该值和当前网络拥塞情况设置发送窗口的大小，所以发送窗口的大小是不断变化的。</p>
<p>当发送端接收到应答报文后，会随之将窗口进行滑动</p>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1621306811825.png" alt="enter description here"></p>
...
<ul>
<li>慢开始算法
慢开始算法，顾名思义，就是在传输开始时将发送窗口慢慢指数级扩大，从而避免一开始就传输大量数据导致网络拥塞。想必大家都下载过资源，每当我们开始下载的时候都会发现下载速度是慢慢提升的，而不是一蹴而就直接拉满带宽。</li>
</ul>
<p>慢开始算法步骤具体如下</p>
<ol>
...
<p><strong>TCP New Ren 改进后的快恢复</strong></p>
...
<h3 id="通信类" tabindex="-1"><a class="header-anchor" href="#通信类" aria-hidden="true">#</a> 通信类</h3>
<h4 id="什么是同源策略及限制" tabindex="-1"><a class="header-anchor" href="#什么是同源策略及限制" aria-hidden="true">#</a> 什么是同源策略及限制？</h4>
<ul>
<li>同源：<strong>协议</strong>，<strong>域名</strong>，<strong>端口</strong>三者必须一致！</li>
</ul>
<p>同源策略限制两个不同源加载的文档和脚本进行交互，它是一个隔离潜在恶意文件的安全机制。</p>
<ul>
<li>限制：
<ul>
<li>cookie LocalStorage IndexDB 无法获取</li>
<li>DOM 无法取得</li>
<li>Ajax 不能发送</li>
</ul>
</li>
</ul>
<p>前端： <code v-pre>http://a.com:8080/</code>；
server： <code v-pre>https://b.com/api/xxx</code></p>
<p><code v-pre>http</code> <code v-pre>https</code>是协议 ， <code v-pre>a.com</code>是域名 ， 默认端口是<code v-pre>80</code>。
如上， 协议， 域名， 端口都不相同， 无法发送请求。</p>
<h4 id="为什么浏览器要使用同源策略" tabindex="-1"><a class="header-anchor" href="#为什么浏览器要使用同源策略" aria-hidden="true">#</a> 为什么浏览器要使用同源策略？</h4>
...
<p>然后我们来考虑一个问题，请求跨域了，那么请求到底发出去没有？ 请求必然是发出去了，但是浏览器拦截了响应。你可能会疑问明明通过表单的方式可以发起跨域请求，为什么 Ajax 就不会。因为归根结底，跨域是为了阻止用户读取到另一个域名下的内容，Ajax 可以获取响应，浏览器认为这不安全，所以拦截了响应。但是表单并不会获取新的内容，所以可以发起跨域请求。同时也说明了跨域并不能完全阻止 CSRF，因为请求毕竟是发出去了。</p>
<p><strong>加载图片，js，css 可无视同源策略</strong></p>
<ul>
<li><code v-pre>&lt;img/&gt;</code>可用于统计打点，可使用第三方统计服务</li>
<li><code v-pre>&lt;link/&gt;</code>、<code v-pre>&lt;script/&gt;</code>可使用 CDN， CDN 一般都是外域</li>
<li><code v-pre>&lt;script/&gt;</code>可实现 JSONP</li>
</ul>
<h4 id="你有几种方式可以解决跨域问题" tabindex="-1"><a class="header-anchor" href="#你有几种方式可以解决跨域问题" aria-hidden="true">#</a> 你有几种方式可以解决跨域问题？</h4>
<ul>
<li>JSONP</li>
</ul>
<p>利用 <code v-pre>&lt;script&gt;</code> 标签没有跨域限制。通过 <code v-pre>&lt;script&gt;</code> 标签指向一个需要访问的地址并提供一个回调函数来接收数据。</p>
<p>JSONP 使用简单且兼容性不错，但是只限于 <code v-pre>get</code> 请求。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>服务器返回的东西类似于以下代码</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>jsonp({})
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="手动封装-sonp" tabindex="-1"><a class="header-anchor" href="#手动封装-sonp" aria-hidden="true">#</a> 手动封装 SONP</h5>
<p>在开发中可能会遇到多个 JSONP 请求的回调函数名是相同的，这时候就需要自己封装一个 JSONP，以下是简单实现:</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">jsonp</span><span class="token punctuation">(</span><span class="token parameter">url<span class="token punctuation">,</span> jsonpCallback<span class="token punctuation">,</span> success</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
<span class="token function">jsonp</span><span class="token punctuation">(</span><span class="token string">'https://webapi.amap.com/maps?v=1.4.10&amp;key=76&amp;callback=onmaploaded'</span><span class="token punctuation">,</span> <span class="token string">'onmaploaded'</span><span class="token punctuation">,</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">value</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>value<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>原理：</strong></p>
<ol>
<li>jsonp 发送的不是 ajax 请求。</li>
<li>jsonp 动态创建一个<code v-pre>script</code>标签， 因为<code v-pre>script</code>标签是没有同源策略限制的，是可以跨域的。</li>
<li>把这个<code v-pre>script</code>标签的src指向我们请求的服务端地址， 这个地址会携带一个参数：callback。 一个回调函数 ， 服务端会把数据通过这个回调函数返回给客户端，但是客户端没有这个函数怎么接受呢？ 所以在发送请求之前，要在全局（window）注册这样一个方法， 利用这个方法， 来获得数据。</li>
...
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1582717982532.png" alt="enter description here"></p>
<p>虽然设置 CORS 和前端没什么关系，但是通过这种方式解决跨域问题的话，会在发送请求时出现两种情况，分别为简单请求和复杂请求。</p>
<ul>
<li>简单请求
以 Ajax 为例，当满足以下条件时，会触发简单请求</li>
</ul>
<ol>
<li>
<p>使用下列方法之一：</p>
...
<li>
<p><code v-pre>Content-Type</code> 的值仅限于下列三者之一：</p>
<ul>
<li>text/plain</li>
...
<p>请求中的任意 <code v-pre>XMLHttpRequestUpload</code> 对象均没有注册任何事件监听器； <code v-pre>XMLHttpRequestUpload</code> 对象可以使用 <code v-pre>XMLHttpRequest.upload</code> 属性访问。</p>
<ul>
<li>复杂请求</li>
</ul>
<p>那么很显然，不符合以上条件的请求就肯定是复杂请求了。</p>
<p>对于复杂请求来说，首先会发起一个预检请求，该请求是 <code v-pre>option</code> 方法的，通过该请求来知道服务端是否允许跨域请求。</p>
<p>对于预检请求来说，如果你使用过 Node 来设置 CORS 的话，可能会遇到过这么一个坑</p>
<p>以下以 express 框架举例：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>app<span class="token punctuation">.</span><span class="token function">use</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">req<span class="token punctuation">,</span> res<span class="token punctuation">,</span> next</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>该请求会验证你的 Authorization 字段，没有的话就会报错。</p>
<p>当前端发起了复杂请求后，你会发现就算你代码是正确的，返回结果也永远是报错的。因为预检请求也会进入回调中，也会触发 next 方法，因为预检请求并不包含 Authorization 字段，所以服务端会报错。</p>
<p>想解决这个问题很简单，只需要在回调中过滤 option 方法即可</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>res<span class="token punctuation">.</span>statusCode <span class="token operator">=</span> <span class="token number">204</span>
...
<p>获取嵌入页面中的第三方页面数据。一个页面发送消息，另一个页面判断来源并接收消息</p>
...
<p>该方式只能用于二级域名相同的情况下，比如 <code v-pre>a.test.com</code> 和 <code v-pre>b.test.com</code> 适用于该方式。</p>
<p>只需要给页面添加 <code v-pre>document.domain = 'test.com'</code> 表示二级域名都相同就可以实现跨域</p>
<h4 id="ajax-原理" tabindex="-1"><a class="header-anchor" href="#ajax-原理" aria-hidden="true">#</a> Ajax 原理</h4>
<p><code v-pre>Ajax</code>的原理简单来说是在用户和服务器之间<strong>加了—个中间层(<code v-pre>AJAX</code>引擎)</strong>，通过<code v-pre>XmlHttpRequest</code>对象来<strong>向服务器发异步请求</strong>，从服务器<strong>获得数据</strong>，然后用<code v-pre>JS</code>来<strong>操作<code v-pre>DOM</code>而更新页面</strong>。使用户操作与服务器响应<strong>异步化</strong>。<code v-pre>XMLHttpRequest</code>是<code v-pre>ajax</code>的核心机制。</p>
<h4 id="ajax-具体怎么实现" tabindex="-1"><a class="header-anchor" href="#ajax-具体怎么实现" aria-hidden="true">#</a> Ajax 具体怎么实现?</h4>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">let</span> xhr <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">XMLHttpRequest</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
xhr<span class="token punctuation">.</span><span class="token function-variable function">onreadystatechange</span> <span class="token operator">=</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">if</span> <span class="token punctuation">(</span>xhr<span class="token punctuation">.</span>readyState <span class="token operator">==</span> <span class="token number">4</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span> <span class="token keyword">catch</span> <span class="token punctuation">(</span>ex<span class="token punctuation">)</span> <span class="token punctuation">{</span>
      <span class="token comment">// 假设由ontimeout处理</span>
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
...
xhr<span class="token punctuation">.</span>timeout <span class="token operator">=</span> <span class="token number">1000</span><span class="token punctuation">;</span> <span class="token comment">// 设置1秒超时</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="安全防范" tabindex="-1"><a class="header-anchor" href="#安全防范" aria-hidden="true">#</a> 安全防范</h3>
<h4 id="什么是-xss-攻击-如何防范-xss-攻击" tabindex="-1"><a class="header-anchor" href="#什么是-xss-攻击-如何防范-xss-攻击" aria-hidden="true">#</a> 什么是 XSS 攻击？如何防范 XSS 攻击？</h4>
<p>基本概念: <strong>跨域脚本攻击</strong></p>
<p>XSS 简单点来说，就是攻击者将可以执行的代码注入到网页中。</p>
<p><strong>举例：</strong></p>
<ul>
<li>一个博客网站, 我发表一篇博客， 其中嵌入<code v-pre>&lt;script&gt;</code>脚本</li>
<li>脚本内容： 获取 cookie ， 发送到我的服务器（服务器配合跨域）</li>
<li>发布这篇博客， 有人查看它， 我轻松收割访问者的 cookie</li>
</ul>
<h5 id="防范" tabindex="-1"><a class="header-anchor" href="#防范" aria-hidden="true">#</a> 防范:</h5>
<p>转义输入输出的内容，对于引号、尖括号、斜杠进行转义</p>
<h4 id="什么是-csrf-攻击-如何防范-csrf-攻击" tabindex="-1"><a class="header-anchor" href="#什么是-csrf-攻击-如何防范-csrf-攻击" aria-hidden="true">#</a> 什么是 CSRF 攻击？如何防范 CSRF 攻击？</h4>
<p>CSRF , 通常称为<strong>跨站请求伪造</strong></p>
...
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>img</span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://www.domain.com/xxx?comment='attack'<span class="token punctuation">"</span></span><span class="token punctuation">/></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>那么你是否会想到使用 POST 方式提交请求是不是就没有这个问题了呢？其实并不是，使用这种方式也不是百分百安全的，攻击者同样可以诱导用户进入某个页面，在页面中通过表单提交 POST 请求。</p>
<p><strong>预防：</strong></p>
<ol>
<li>Get 请求不对数据进行修改</li>
<li>不让第三方网站访问到用户 <code v-pre>Cookie</code></li>
<li>阻止第三方网站请求接口</li>
<li>请求时附带验证信息，比如验证码或者 Token
<ol>
<li>token 验证：登陆成功后服务器下发 token 令牌存到用户本地，再次访问时要<strong>主动发送 token</strong>，浏览器只能主动发<code v-pre>cookie</code>，做不到主动发<code v-pre>token</code></li>
<li>referer 验证：判断页面来源是否自己站点的页面，不是不执行请求</li>
<li>隐藏令牌： 令牌放在<code v-pre>http header</code>头中，而不是链接中 (和<code v-pre>token</code>类似)</li>
<li>验证码。</li>
</ol>
</li>
</ol>
<p><strong>SameSite</strong>
可以对 <code v-pre>Cookie</code> 设置 <code v-pre>SameSite</code> 属性。该属性表示 Cookie 不随着跨域请求发送，可以很大程度减少 CSRF 的攻击，但是该属性目前并不是所有浏览器都兼容。</p>
<p><strong>验证 Referer</strong>
对于需要防范 CSRF 的请求，我们可以通过验证 Referer 来判断该请求是否为第三方网站发起的。</p>
<p>Token
服务器下发一个随机 Token，每次发起请求时将 Token 携带上，服务器验证 Token 是否有效。</p>
<h4 id="csrf-与-xss-的区别" tabindex="-1"><a class="header-anchor" href="#csrf-与-xss-的区别" aria-hidden="true">#</a> CSRF 与 XSS 的区别：</h4>
<p>CSRF 需要用户登陆，利用网站自己的接口漏洞进行攻击</p>
<p>xss 通过注入脚本执行自己的代码</p>
<h4 id="什么是点击劫持-如何防范点击劫持" tabindex="-1"><a class="header-anchor" href="#什么是点击劫持-如何防范点击劫持" aria-hidden="true">#</a> 什么是点击劫持？如何防范点击劫持？</h4>
<p>点击劫持是一种视觉欺骗的攻击手段。攻击者将需要攻击的网站通过 <code v-pre>iframe</code> 嵌套的方式嵌入自己的网页中，并将 <code v-pre>iframe</code> 设置为透明，在页面中透出一个按钮诱导用户点击。</p>
<ul>
<li>X-FRAME-OPTIONS
<code v-pre>X-FRAME-OPTIONS</code> 是一个 HTTP 响应头，在现代浏览器有一个很好的支持。这个 HTTP 响应头 就是为了防御用 <code v-pre>iframe</code> 嵌套的点击劫持攻击。</li>
</ul>
<p>该响应头有三个值可选，分别是</p>
<ul>
<li><code v-pre>DENY</code>，表示页面不允许通过 iframe 的方式展示</li>
<li><code v-pre>SAMEORIGIN</code>，表示页面可以在相同域名下通过 iframe 的方式展示</li>
<li><code v-pre>ALLOW-FROM</code>，表示页面可以在指定来源的 iframe 中展示</li>
</ul>
<p>JS 防御
对于某些远古浏览器来说，并不能支持上面的这种方式，那我们只有通过 JS 的方式来防御点击劫持了。</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上代码的作用就是当通过 iframe 的方式加载页面时，攻击者的网页直接不显示所有内容了。</p>
<h4 id="什么是中间人攻击-如何防范中间人攻击" tabindex="-1"><a class="header-anchor" href="#什么是中间人攻击-如何防范中间人攻击" aria-hidden="true">#</a> 什么是中间人攻击？如何防范中间人攻击？</h4>
...
<h4 id="有几种方式可以实现存储功能-分别有什么优缺点" tabindex="-1"><a class="header-anchor" href="#有几种方式可以实现存储功能-分别有什么优缺点" aria-hidden="true">#</a> 有几种方式可以实现存储功能，分别有什么优缺点？</h4>
<p>cookie，localStorage，sessionStorage，indexDB</p>
<p>我们先来通过表格学习下这几种存储方式的区别:</p>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1584256285204.png" alt="存储"></p>
<p>从上表可以看到，<code v-pre>cookie</code> 已经不建议用于存储。如果没有大量数据存储需求的话，可以使用 <code v-pre>localStorage</code> 和 <code v-pre>sessionStorage</code> 。对于不怎么改变的数据尽量使用 <code v-pre>localStorage</code> 存储，否则可以用 <code v-pre>sessionStorage</code> 存储。</p>
<p>对于<code v-pre>cookie</code> 来说，我们还需要注意安全性。</p>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1584256604881.png" alt="cookie"></p>
<h3 id="浏览器渲染原理" tabindex="-1"><a class="header-anchor" href="#浏览器渲染原理" aria-hidden="true">#</a> 浏览器渲染原理</h3>
<h4 id="输入-url-到页面渲染的整个流程" tabindex="-1"><a class="header-anchor" href="#输入-url-到页面渲染的整个流程" aria-hidden="true">#</a> 输入 URL 到页面渲染的整个流程</h4>
<h5 id="一-首先浏览器根据请求的-url-交给-dns-域名解析" tabindex="-1"><a class="header-anchor" href="#一-首先浏览器根据请求的-url-交给-dns-域名解析" aria-hidden="true">#</a> 一. 首先浏览器根据请求的 URL 交给 DNS 域名解析</h5>
<p>DNS 的作用就是通过域名查询到具体的 IP。</p>
<p>因为 IP 存在数字和英文的组合（IPv6），很不利于人类记忆，所以就出现了域名。可以把域名看成是某个 IP 的别名，DNS 就是去查询这个别名的真正名称是什么。</p>
<p>在 TCP 握手之前就已经进行了 DNS 查询，这个查询是操作系统自己做的。当你在浏览器中想访问 <code v-pre>www.google.com</code> 时，会进行一下操作：</p>
<ul>
<li>DNS 查询解析的详细过程</li>
</ul>
<p>过程：<code v-pre>. -&gt; .com -&gt; google.com. -&gt; www.google.com</code></p>
<ol>
<li>首先在<strong>本地域名服务器</strong>中查询 IP 地址</li>
<li>如果没有找到的情况下，本地域名会向<strong>根域名服务器</strong>发送请求</li>
<li>如果根域名服务器也不存在该域名时，本地域名会向<strong>com 顶级域名服务器</strong>发送请求</li>
<li>依次类推下去。直到最后本地域名服务器得到<code v-pre>google</code>的 IP 地址并把它缓存到本地，供下次查询使用。</li>
</ol>
<h5 id="二-接下来是-tcp-三次握手" tabindex="-1"><a class="header-anchor" href="#二-接下来是-tcp-三次握手" aria-hidden="true">#</a> 二. 接下来是 TCP 三次握手：</h5>
<ol>
<li>得到 ip 地址后向服务器<strong>发送请求报文</strong></li>
<li>服务器收到请求报文后，<strong>如同意连接</strong>，则向客户端<strong>发送确认报文</strong></li>
<li>客户端收到服务器的确认后，<strong>再次向服务器发出确认报文</strong>，完成连接。</li>
</ol>
<h5 id="三-浏览器接收相应的数据后开始解析文件" tabindex="-1"><a class="header-anchor" href="#三-浏览器接收相应的数据后开始解析文件" aria-hidden="true">#</a> 三. 浏览器接收相应的数据后开始解析文件</h5>
...
<ul>
<li>
<p>根据 HTML 构建 DOM 树。</p>
</li>
<li>
<p>有 CSS 的话会去构建 CSSOM 树。</p>
</li>
<li>
<p>如果遇到 script 标签的话，会判断是否存在 <code v-pre>async</code> 或者 <code v-pre>defer</code> ，<code v-pre>async</code>的话并行下载并执行 JS，<code v-pre>defer</code>的话会先下载文件，然后等待 HTML 解析完成后按顺序执行。</p>
</li>
<li>
<p>CSSOM 树和 DOM 树构建完成后结合后生成 Render 树，确定页面元素的布局、样式等。在生成 Render 树的过程中，浏览器就开始调用 GPU 绘制，合成图层，将要显示的节点显示在页面。</p>
</li>
</ul>
<h4 id="浏览器渲染过程" tabindex="-1"><a class="header-anchor" href="#浏览器渲染过程" aria-hidden="true">#</a> 浏览器渲染过程？</h4>
<div class="custom-container tip">
<p class="custom-container-title">Tips</p>
...
<h5 id="浏览器接收到-html-文件并转换为-dom-树" tabindex="-1"><a class="header-anchor" href="#浏览器接收到-html-文件并转换为-dom-树" aria-hidden="true">#</a> 浏览器接收到 HTML 文件并转换为 DOM 树</h5>
<p><code v-pre>字节数据 =&gt; 字符串 =&gt; Token =&gt; Node =&gt; DOM</code></p>
<ul>
<li>当我们打开网页时，浏览器先去请求对应的 HTML 文件。HTML 只是字符串，计算机不识别，网络传输内容都是<code v-pre>0</code>和<code v-pre>1</code>这样的<strong>字节数据</strong>。浏览器会先把<strong>字节数据转换为字符串</strong>，也就是我们写的代码。</li>
<li>然后将字符串<strong>语法分析</strong>转换为<strong>标记</strong>（token）。这一过程在词法分析中叫做标记化（tokenization）。</li>
<li>标记化后紧接着转换为<strong>Node</strong></li>
<li>然后根据 Node 之间的联系构建成<strong>DOM 树</strong>。</li>
<li>在解析 HTML 文件的时候，浏览器还会遇到 CSS 和 JS 文件，这时候浏览器也会去下载并解析这些文件。</li>
</ul>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1620463115865.png" alt="DOM树"></p>
<div class="custom-container tip">
<p class="custom-container-title">Tips</p>
<p>什么是标记呢？？这其实属于编译原理这一块的内容了。简单来说，标记还是字符串，是构成代码的<strong>最小单位</strong>。这一过程会将代码分拆成一块块，并给这些内容打上标记，便于理解这些最小单位的代码是什么意思。
<img src="https://gitee.com/l544402029/res/raw/master/小书匠/1620462997739.png" alt="标记"></p>
</div>
<h5 id="将-css-文件转换为-cssom-树" tabindex="-1"><a class="header-anchor" href="#将-css-文件转换为-cssom-树" aria-hidden="true">#</a> 将 CSS 文件转换为 CSSOM 树</h5>
<ul>
<li>和转化 DOM 树基本相似，浏览器会<strong>先确定每个节点的样式</strong>，样式可以自行设置，也是可以继承的。（<strong>很消耗资源</strong>）</li>
<li>浏览器需要<strong>递归 CSSOM</strong> 树，确定元素的具体样式。</li>
<li>由于递归过程是很复杂的，我们应该避免写<strong>过于具体</strong>的 CSS 选择器，HTML 也不要添加无意义标签，保证<strong>层级扁平</strong>。</li>
</ul>
<h5 id="生成渲染树" tabindex="-1"><a class="header-anchor" href="#生成渲染树" aria-hidden="true">#</a> 生成渲染树</h5>
<ul>
<li>当我们生成 DOM 树和 CSSOM 树以后，就需要将这两棵树组合为渲染树。</li>
<li>渲染树只会渲染<strong>需要显示的节点</strong>，如果<code v-pre>display: none</code>就不会显示。</li>
<li>然后开始进行布局，（也可以叫做回流），调用 GPU 绘制，合成图层，显示在页面。</li>
</ul>
<h4 id="加载一个资源的过程" tabindex="-1"><a class="header-anchor" href="#加载一个资源的过程" aria-hidden="true">#</a> 加载一个资源的过程</h4>
<ol>
<li>浏览器根据 DNS 服务器获取域名的 IP 地址</li>
<li>向这个 IP 的服务器发送 http 请求</li>
<li>服务器收到,处理,并返回 http 请求</li>
<li>浏览器得到返回内容</li>
</ol>
<h4 id="为什么操作-dom-慢" tabindex="-1"><a class="header-anchor" href="#为什么操作-dom-慢" aria-hidden="true">#</a> 为什么操作 DOM 慢？</h4>
<p>想必大家都听过操作 DOM 性能很差，但是这其中的原因是什么呢？</p>
<p>因为 DOM 是属于渲染引擎中的东西，而 JS 又是 JS 引擎中的东西。当我们通过 JS 操作 DOM 的时候，其实这个操作涉及到了<strong>两个线程之间的通信</strong>，那么势必会带来一些性能上的损耗。操作 DOM 次数一多，也就等同于一直在进行线程之间的通信，并且操作 DOM 可能还会带来<strong>重绘回流</strong>的情况，所以也就导致了性能上的问题。</p>
<h4 id="插入几万个-dom-如何实现页面不卡顿" tabindex="-1"><a class="header-anchor" href="#插入几万个-dom-如何实现页面不卡顿" aria-hidden="true">#</a> 插入几万个 DOM，如何实现页面不卡顿？</h4>
<p>使用<a href="https://github.com/bvaughn/react-virtualized" target="_blank" rel="noopener noreferrer">虚拟滚动（virtualized scroller）<ExternalLinkIcon/></a>。
这种技术的原理就是只渲染可视区域内的内容，非可见区域的那就完全不渲染了，当用户在滚动的时候就实时去替换渲染的内容。</p>
<h4 id="什么情况阻塞渲染" tabindex="-1"><a class="header-anchor" href="#什么情况阻塞渲染" aria-hidden="true">#</a> 什么情况阻塞渲染?</h4>
<p>首先渲染的前提是生成渲染树，所以 <strong>HTML</strong> 和 <strong>CSS</strong> 肯定会阻塞渲染。如果你想渲染的越快，你越应该降低一开始需要渲染的<strong>文件大小</strong>，并且<strong>扁平层级</strong>，<strong>优化选择器</strong>。</p>
<p>然后当浏览器在解析到 <code v-pre>script</code>标签时，会暂停构建 DOM，完成后才会从暂停的地方重新开始。也就是说，如果你想首屏渲染的越快，就越不应该在首屏就加载 JS 文件，这也是都建议将 <code v-pre>script</code>标签放在 <code v-pre>body</code> 标签底部的原因。</p>
<p>当然在当下，并不是说 <code v-pre>script</code>标签必须放在底部，因为你可以给 <code v-pre>script</code>标签添加 <code v-pre>defer</code>或者 <code v-pre>async</code>属性。</p>
<p>当 <code v-pre>script</code>标签加上 <code v-pre>defer</code> 属性以后，表示该 JS 文件会并行下载，但是会放到 HTML 解析完成后顺序执行，所以对于这种情况你可以把 <code v-pre>script</code>标签放在任意位置。</p>
<p><code v-pre>async</code> 属性下载完就立即执行，会阻塞 html 解析</p>
<h3 id="性能优化" tabindex="-1"><a class="header-anchor" href="#性能优化" aria-hidden="true">#</a> 性能优化</h3>
<h4 id="如何进行性能优化" tabindex="-1"><a class="header-anchor" href="#如何进行性能优化" aria-hidden="true">#</a> 如何进行性能优化?</h4>
<ol>
<li>
<p>多使用内存 , 缓存 , 减少 cpu 计算</p>
<ul>
<li>
<p>强缓存表示在缓存期间，不需要请求，<code v-pre>State Code</code>为 200，<code v-pre>Cache-Control</code>可以组合使用多个</p>
</li>
<li>
<p>强缓存可以通过设置<code v-pre>Expires</code> <code v-pre>Cache-Control</code>来实现。如果两个都有以后者为准。</p>
</li>
<li>
<p>协商缓存： 协商缓存表示如果缓存过期了，那么就需要重新发起请求验证资源是否有更新，</p>
</li>
<li>
<p>可通过设置<code v-pre>HTTP Header</code>的<code v-pre>Last-Modified</code>和<code v-pre>ETag</code>来实现，如果资源没有改变，<code v-pre>State Code</code>为<code v-pre>304</code></p>
</li>
</ul>
</li>
</ol>
<ol start="2">
<li>
<p>资源压缩 ,合并, 减少 http 请求</p>
</li>
<li>
<p>非核心代码异步加载</p>
<h5 id="异步加载的方式" tabindex="-1"><a class="header-anchor" href="#异步加载的方式" aria-hidden="true">#</a> 异步加载的方式</h5>
<ol>
<li>动态脚本加载：动态创建 script 标签添加到页面</li>
<li><code v-pre>defer</code>: 在 html 解析完成执行 , 如果是多个 , 则按照加载顺序执行</li>
<li><code v-pre>async</code>: 加载完成后立即执行 , 如果是多个 , 执行顺序与加载顺序无关</li>
</ol>
</li>
<li>
<p>使用 CDN：</p>
...
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>meta</span> <span class="token attr-name">http-equiv</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>x-dns-prefetch-control<span class="token punctuation">"</span></span> <span class="token attr-name">content</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>on<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
//在https中强制打开a标签预解析

<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>link</span> <span class="token attr-name">rel</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>dns-prefetch<span class="token punctuation">"</span></span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>//baidu.com<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span> //dns预解析
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="图片类" tabindex="-1"><a class="header-anchor" href="#图片类" aria-hidden="true">#</a> 图片类:</h4>
<ol>
<li>
<p>修饰类图片用 css</p>
</li>
...
<li>
<p>对于移动端来说，屏幕宽度就那么点，完全没有必要去加载原图浪费带宽。一般图片都用 CDN 加载，可以计算出适配屏幕的宽度，然后去请求相应裁剪好的图片。</p>
</li>
<li>
<p>小图使用 base64 格式</p>
</li>
...
<p class="custom-container-title">Tips</p>
<p>照片使用 JPEG</p>
<p>小图 , 图标 ,背景类使用 png 或者 svg</p>
<p>对于能够显示 WebP 格式的浏览器尽量使用 WebP 格式。因为 WebP 格式具有更好的图像数据压缩算法，能带来更小的图片体积，而且拥有肉眼识别无差异的图像质量，缺点就是兼容性并不好</p>
</div>
<h4 id="css-类" tabindex="-1"><a class="header-anchor" href="#css-类" aria-hidden="true">#</a> CSS 类:</h4>
<ol>
<li>
<p>css 放在 head 里 (先加载 css 然后渲染 否则渲染两次)</p>
</li>
<li>
<p>不使用 css 表达式</p>
</li>
<li>
<p>正确使用选择器 (应从右向左匹配 , 避免层级过多 , 扁平化)</p>
</li>
</ol>
<h4 id="js-类" tabindex="-1"><a class="header-anchor" href="#js-类" aria-hidden="true">#</a> JS 类:</h4>
<ol>
<li>
<p>JS 放在 body 最下面 (不会阻塞渲染过程 性能优化问题； 再执行 JS script 能拿到所有标签)</p>
</li>
<li>
<p>减少 DOM 操作 , 对 DOM 查询进行缓存</p>
</li>
<li>
<p>频繁 DOM 操作， 合并到一起插入 DOM 结构</p>
</li>
<li>
<p>尽早在 dom 渲染完就执行，用 DOMContentLoaded 触发</p>
</li>
<li>
<p>删除不需要的脚本</p>
</li>
...
<p>隔一段时间发送请求:如在用户输入时,用户输入过快会导致一直发送请求,这时候我们可以使用节流函数,使隔一小段时间发送请求.</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// func是用户传入需要防抖的函数</span>
...
<li>防抖:
有一个按钮点击会触发网络请求，但是我们并不希望每次点击都发起网络请求，而是当用户点击按钮一段时间后没有再次点击的情况才去发起网络请求，对于这种情况我们就可以使用防抖。</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// func是用户传入需要防抖的函数</span>
<span class="token comment">// wait是等待时间</span>
...
<span class="token keyword">var</span> btn <span class="token operator">=</span> document<span class="token punctuation">.</span><span class="token function">getElementById</span><span class="token punctuation">(</span><span class="token string">'input'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
btn<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span>
  ...
  <span class="token function">debounce</span><span class="token punctuation">(</span><span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token string">'发送ajax请求'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">,</span>
...
<p>如果有些资源需要马上使用，可以使用如下代码实现，预加载不会阻塞<code v-pre>onload</code>事件</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>link</span> <span class="token attr-name">rel</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>preload<span class="token punctuation">"</span></span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://example.com<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ol start="9">
<li>预渲染:
<ul>
<li>要确保用户大概率会打开的资源进行预渲染，可以提升网页的加载速度</li>
</ul>
</li>
</ol>
<p>可以通过预渲染将下载的文件预先在后台渲染，</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>link</span> <span class="token attr-name">rel</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>prerender<span class="token punctuation">"</span></span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://example.com<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ol start="10">
<li>懒加载:</li>
</ol>
<p>懒加载就是将不关键的资源延后加载。</p>
<p>对于图片来说，先设置图片标签的 <code v-pre>src</code> 属性为一张占位图，将真实的图片资源放入一个自定义属性中，当进入自定义区域时，就将自定义属性替换为 <code v-pre>src</code> 属性，这样图片就会去下载资源，实现了图片懒加载。</p>
<p>懒加载不仅可以用于图片，也可以使用在别的资源上。比如进入可视区域才开始播放视频等等。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> myImage <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">return</span> <span class="token punctuation">{</span>
    <span class="token function-variable function">setSrc</span><span class="token operator">:</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">src</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
      imgNode<span class="token punctuation">.</span>src <span class="token operator">=</span> <span class="token string">'loading.gif'</span><span class="token punctuation">;</span>
      img<span class="token punctuation">.</span>src <span class="token operator">=</span> src<span class="token punctuation">;</span>
    <span class="token punctuation">}</span><span class="token punctuation">,</span>
  <span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
myImage<span class="token punctuation">.</span><span class="token function">setSrc</span><span class="token punctuation">(</span><span class="token string">'https://img1.sycdn.imooc.com/5c09123400014ba418720632.jpg'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="浏览器缓存机制" tabindex="-1"><a class="header-anchor" href="#浏览器缓存机制" aria-hidden="true">#</a> 浏览器缓存机制</h3>
...
<h5 id="service-worker" tabindex="-1"><a class="header-anchor" href="#service-worker" aria-hidden="true">#</a> Service Worker</h5>
<p>Service Worker 的缓存与浏览器其他内建的缓存机制不同，它可以让我们自由控制缓存哪些文件、如何匹配缓存、如何读取缓存，并且缓存是持续性的。
当 Service Worker 没有命中缓存的时候，我们需要去调用 fetch 函数获取数据。也就是说，如果我们没有在 Service Worker 命中缓存的话，会根据缓存查找优先级去查找数据。但是不管我们是从 Memory Cache 中还是从网络请求中获取的数据，浏览器都会显示我们是从 Service Worker 中获取的内容。</p>
<h5 id="memory-cache" tabindex="-1"><a class="header-anchor" href="#memory-cache" aria-hidden="true">#</a> Memory Cache</h5>
<p>Memory Cache 也就是内存中的缓存，读取内存中的数据肯定比磁盘快。但是内存缓存虽然读取高效，可是缓存持续性很短，会随着进程的释放而释放。 一旦我们关闭 Tab 页面，内存中的缓存也就被释放了。
当我们访问过页面以后，再次刷新页面，可以发现很多数据都来自于内存缓存
那么既然内存缓存这么高效，我们是不是能让数据都存放在内存中呢？</p>
<p>先说结论，这是不可能的。首先计算机中的内存一定比硬盘容量小得多，操作系统需要精打细算内存的使用，所以能让我们使用的内存必然不多。内存中其实可以存储大部分的文件，比如说 JSS、HTML、CSS、图片等等。但是浏览器会把哪些文件丢进内存这个过程就很玄学了，我查阅了很多资料都没有一个定论。</p>
<p>当然，我通过一些实践和猜测也得出了一些结论：</p>
<ul>
<li>对于大文件来说，大概率是不存储在内存中的，反之优先</li>
<li>当前系统内存使用率高的话，文件优先存储进硬盘</li>
</ul>
<h5 id="disk-cache" tabindex="-1"><a class="header-anchor" href="#disk-cache" aria-hidden="true">#</a> Disk Cache</h5>
...
<h5 id="push-cache" tabindex="-1"><a class="header-anchor" href="#push-cache" aria-hidden="true">#</a> Push Cache</h5>
<p>Push Cache 是 HTTP/2 中的内容，当以上三种缓存都没有命中时，它才会被使用。并且缓存时间也很短暂，只在会话（Session）中存在，一旦会话结束就被释放。</p>
<p>Push Cache 在国内能够查到的资料很少，也是因为 HTTP/2 在国内不够普及，但是 HTTP/2 将会是日后的一个趋势。这里推荐阅读  <a href="https://jakearchibald.com/2017/h2-push-tougher-than-i-thought/" target="_blank" rel="noopener noreferrer">HTTP/2 push is tougher than I thought<ExternalLinkIcon/></a> 这篇文章，但是内容是英文的，我翻译一下文章中的几个结论，有能力的同学还是推荐自己阅读</p>
<ul>
...
<h5 id="网络请求" tabindex="-1"><a class="header-anchor" href="#网络请求" aria-hidden="true">#</a> 网络请求</h5>
<p>如果所有缓存都没有命中的话，那么只能发起请求来获取资源了。</p>
<p>那么为了性能上的考虑，大部分的接口都应该选择好缓存策略，接下来我们就来学习缓存策略这部分的内容。</p>
<h4 id="缓存策略" tabindex="-1"><a class="header-anchor" href="#缓存策略" aria-hidden="true">#</a> 缓存策略</h4>
<p>通常浏览器缓存策略分为两种：强缓存和协商缓存，并且缓存策略都是通过设置 HTTP Header 来实现的。</p>
<h5 id="强缓存" tabindex="-1"><a class="header-anchor" href="#强缓存" aria-hidden="true">#</a> 强缓存</h5>
<p>强缓存可以通过设置两种 HTTP Header 实现：<code v-pre>Expires</code> 和 <code v-pre>Cache-Control</code> 。强缓存表示在缓存期间不需要请求，<code v-pre>state code</code> 为 200。</p>
<ul>
<li>Expires</li>
</ul>
<div class="language-http ext-http line-numbers-mode"><pre v-pre class="language-http"><code><span class="token header"><span class="token header-name keyword">Expires</span><span class="token punctuation">:</span> <span class="token header-value">Wed, 22 Oct 2018 08:41:00 GMT</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code v-pre>Expires</code> 是 HTTP/1 的产物，表示资源会在 <code v-pre>Wed, 22 Oct 2018 08:41:00 GMT</code> 后过期，需要再次请求。并且 <code v-pre>Expires</code> <strong>受限于本地时间</strong>，如果修改了本地时间，可能会造成缓存失效。</p>
<ul>
<li>Cache-control</li>
</ul>
<div class="language-http ext-http line-numbers-mode"><pre v-pre class="language-http"><code><span class="token header"><span class="token header-name keyword">Cache-control</span><span class="token punctuation">:</span> <span class="token header-value">max-age=30</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code v-pre>Cache-Control</code> 出现于 HTTP/1.1，<strong>优先级高于</strong> <code v-pre>Expires</code> 。该属性值表示资源会在 30 秒后过期，需要再次请求。</p>
<p><code v-pre>Cache-Control</code> <strong>可以在请求头或者响应头中设置</strong>，并且可以组合使用多种指令</p>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1620460652836.png" alt=""></p>
...
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1620460740234.png" alt=""></p>
<h5 id="协商缓存" tabindex="-1"><a class="header-anchor" href="#协商缓存" aria-hidden="true">#</a> 协商缓存</h5>
<p>如果缓存过期了，就需要发起请求验证资源是否有更新。协商缓存可以通过设置两种 HTTP Header 实现：<code v-pre>Last-Modified</code> 和 <code v-pre>ETag</code> 。</p>
<p>当浏览器发起请求验证资源时，如果资源没有做改变，那么服务端就会返回 304 状态码，并且更新浏览器缓存有效期。</p>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1620460988968.png" alt=""></p>
<ul>
<li>Last-Modified 和 If-Modified-Since</li>
</ul>
<p><code v-pre>Last-Modified</code> 表示本地文件最后修改日期，<code v-pre>If-Modified-Since</code> 会将 <code v-pre>Last-Modified</code> 的值发送给服务器，询问服务器在该日期后资源是否有更新，有更新的话就会将新的资源发送回来，否则返回 304 状态码。</p>
<p>但是 Last-Modified 存在一些弊端：</p>
<ul>
<li>
<p>如果本地打开缓存文件，即使没有对文件进行修改，但还是会造成 <code v-pre>Last-Modified</code> 被修改，服务端不能命中缓存导致发送相同的资源</p>
</li>
<li>
<p>因为 <code v-pre>Last-Modified</code> 只能以秒计时，如果在不可感知的时间内修改完成文件，那么服务端会认为资源还是命中了，不会返回正确的资源
因为以上这些弊端，所以在 HTTP / 1.1 出现了 <code v-pre>ETag</code> 。</p>
</li>
<li>
<p>ETag 和 If-None-Match
<code v-pre>ETag</code> 类似于文件指纹，<code v-pre>If-None-Match</code> 会将当前 <code v-pre>ETag</code> 发送给服务器，询问该资源 <code v-pre>ETag</code> 是否变动，有变动的话就将新的资源发送回来。并且 <code v-pre>ETag</code> 优先级比 <code v-pre>Last-Modified</code> 高。</p>
</li>
</ul>
<p>以上就是缓存策略的所有内容了，看到这里，不知道你是否存在这样一个疑问。如果什么缓存策略都没设置，那么浏览器会怎么处理？</p>
<p>对于这种情况，浏览器会采用一个启发式的算法，通常会取响应头中的 <code v-pre>Date</code> 减去 <code v-pre>Last-Modified</code> 值的 10% 作为缓存时间。</p>
<h5 id="实际场景应用缓存策略" tabindex="-1"><a class="header-anchor" href="#实际场景应用缓存策略" aria-hidden="true">#</a> 实际场景应用缓存策略</h5>
<p>单纯了解理论而不付诸于实践是没有意义的，接下来我们来通过几个场景学习下如何使用这些理论。</p>
<ul>
<li>
<p>频繁变动的资源
对于频繁变动的资源，首先需要使用 <code v-pre>Cache-Control: no-cache</code> 使浏览器每次都请求服务器，然后配合 <code v-pre>ETag</code> 或者 <code v-pre>Last-Modified</code> 来验证资源是否有效。这样的做法虽然不能节省请求数量，但是能显著减少响应数据大小。</p>
</li>
<li>
<p>代码文件
这里特指除了 HTML 外的代码文件，因为 HTML 文件一般不缓存或者缓存时间很短。</p>
</li>
</ul>
...
<h3 id="前端监控" tabindex="-1"><a class="header-anchor" href="#前端监控" aria-hidden="true">#</a> 前端监控</h3>
<h4 id="前端监控一般分为哪几种" tabindex="-1"><a class="header-anchor" href="#前端监控一般分为哪几种" aria-hidden="true">#</a> 前端监控一般分为哪几种？</h4>
<p>前端监控一般分为三种，分别为页面埋点、性能监控以及异常监控。</p>
<h4 id="前端错误的分类" tabindex="-1"><a class="header-anchor" href="#前端错误的分类" aria-hidden="true">#</a> 前端错误的分类</h4>
<ul>
<li>即时运行错误：代码错误</li>
<li>资源加载错误</li>
</ul>
<h4 id="错误的捕获方式" tabindex="-1"><a class="header-anchor" href="#错误的捕获方式" aria-hidden="true">#</a> 错误的捕获方式</h4>
<ul>
<li>即时运行错误：代码错误
<ul>
<li>try..catch</li>
...
<li>Error 事件<strong>捕获</strong></li>
</ul>
</li>
</ul>
<h4 id="跨域的-js-运行错误可以捕获吗-错误提示什么-应该怎么处理" tabindex="-1"><a class="header-anchor" href="#跨域的-js-运行错误可以捕获吗-错误提示什么-应该怎么处理" aria-hidden="true">#</a> 跨域的 js 运行错误可以捕获吗？错误提示什么？应该怎么处理</h4>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1587443059574.png" alt="错误捕获"></p>
<ol>
<li>在 script 标签增加<code v-pre>crossorigin</code>属性 <code v-pre>&lt;script src=&quot;...&quot; crossorigin &gt;&lt;/script&gt;</code></li>
<li>设置 js 资源响应头 Access-Control-Allow-Origin:*</li>
</ol>
<h4 id="上报错误的基本原理" tabindex="-1"><a class="header-anchor" href="#上报错误的基本原理" aria-hidden="true">#</a> 上报错误的基本原理</h4>
<ol>
<li>采用 Ajax 通信的方式上报</li>
<li>利用 Image 对象上报</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">new</span> <span class="token class-name">Image</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span>src <span class="token operator">=</span> <span class="token string">'http://baidu.com/tesjk?r=tksjk'</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="浏览器内核" tabindex="-1"><a class="header-anchor" href="#浏览器内核" aria-hidden="true">#</a> 浏览器内核</h3>
<h4 id="能介绍一下你对浏览器内核的理解吗" tabindex="-1"><a class="header-anchor" href="#能介绍一下你对浏览器内核的理解吗" aria-hidden="true">#</a> 能介绍一下你对浏览器内核的理解吗？</h4>
<p>主要分成两部分：渲染引擎(<code v-pre>layout engineer或Rendering Engine</code>)和 JS 引擎</p>
<ul>
<li>渲染引擎：</li>
</ul>
<p>负责取得网页的内容（HTML、XML、图像等等）、整理讯息（例如加入 CSS 等），以及计算网页的显示方式，然后会输出至显示器或打印机。</p>
<p>浏览器的内核的不同对于网页的语法解释会有不同，渲染的效果也会不相同。</p>
<ul>
<li>JS 引擎：</li>
</ul>
<p>解析和执行 javascript 来实现网页的动态效果</p>
<h3 id="seo" tabindex="-1"><a class="header-anchor" href="#seo" aria-hidden="true">#</a> SEO</h3>
<h4 id="前端需要注意哪些-seo" tabindex="-1"><a class="header-anchor" href="#前端需要注意哪些-seo" aria-hidden="true">#</a> 前端需要注意哪些 SEO?</h4>
<ul>
<li>合理的<code v-pre>title</code>、<code v-pre>keywords</code> 。<code v-pre>title</code> 值强调重点即可，不同页面 title 要有所不同，重要关键词出现不要超过 2 次，而且要靠前</li>
<li><strong>语义化</strong>的 HTML 代码，符合 W3C 规范，让搜索引擎容易理解网页</li>
<li>重要内容 HTML 代码<strong>放在最前</strong>：搜索引擎抓取 HTML 顺序是从上到下，有的搜索引擎对抓取长度有限制，保证重要内容一定会被抓取</li>
<li>重要内容<strong>不要用 js 输出</strong>， 爬虫不会执行 js 获取内容</li>
<li><strong>少用<code v-pre>iframe</code></strong>，搜索引擎不会抓取 <code v-pre>iframe</code> 中的内容</li>
<li><strong>非装饰性图片</strong>必须加<code v-pre>alt</code></li>
<li>提高<strong>网站速度</strong>：网站速度是搜索引擎排序的一个重要指标</li>
</ul>
<hr>
<h2 id="html-相关" tabindex="-1"><a class="header-anchor" href="#html-相关" aria-hidden="true">#</a> HTML 相关:</h2>
<h3 id="w3c-标准" tabindex="-1"><a class="header-anchor" href="#w3c-标准" aria-hidden="true">#</a> W3C 标准</h3>
<h4 id="web-标准以及-w3c-标准是什么" tabindex="-1"><a class="header-anchor" href="#web-标准以及-w3c-标准是什么" aria-hidden="true">#</a> WEB 标准以及 W3C 标准是什么?</h4>
<ol>
<li>标签闭合</li>
<li>标签小写</li>
<li>不乱嵌套</li>
...
<h3 id="语义化" tabindex="-1"><a class="header-anchor" href="#语义化" aria-hidden="true">#</a> 语义化</h3>
<h4 id="谈谈你对语义化的理解" tabindex="-1"><a class="header-anchor" href="#谈谈你对语义化的理解" aria-hidden="true">#</a> 谈谈你对语义化的理解？</h4>
<ul>
<li>
<p>用<strong>正确</strong>的标签做正确的事情！</p>
</li>
<li>
<p>语义化就是让页面的<strong>内容结构化</strong>，便于对浏览器、搜索引擎解析。</p>
</li>
<li>
<p>在没有样式 CSS 情况下也以一种<strong>文档格式显</strong>示，并且是容易阅读的。</p>
</li>
<li>
<p><strong>搜索引擎</strong>的爬虫依赖于标记来确定上下文和各个关键字的权重，利于 SEO。</p>
</li>
<li>
<p><strong>源代码</strong>更容易阅读、维护、理解。</p>
</li>
</ul>
<h3 id="xhtml-和-html" tabindex="-1"><a class="header-anchor" href="#xhtml-和-html" aria-hidden="true">#</a> xhtml 和 html</h3>
<ul>
<li>
<p>一个是功能上的差别</p>
<ul>
<li>主要是 XHTML 可兼容各大浏览器、手机以及 PDA，并且浏览器也能快速正确地编译网页</li>
</ul>
</li>
<li>
<p>另外是书写习惯的差别</p>
<ul>
<li>XHTML 元素必须被正确地嵌套，闭合，区分大小写，文档必须拥有根元素</li>
</ul>
</li>
</ul>
<h3 id="global-attribute" tabindex="-1"><a class="header-anchor" href="#global-attribute" aria-hidden="true">#</a> global attribute</h3>
<h4 id="html-全局属性-global-attribute-有哪些" tabindex="-1"><a class="header-anchor" href="#html-全局属性-global-attribute-有哪些" aria-hidden="true">#</a> HTML 全局属性(global attribute)有哪些？</h4>
<ul>
<li><code v-pre>id</code>: 元素 id，文档内唯一</li>
<li><code v-pre>class</code>: 为元素设置类标识</li>
<li><code v-pre>style</code>: 行内 css 样式</li>
<li><code v-pre>title</code>: 元素相关的建议信息</li>
<li><code v-pre>lang</code>: 元素内容的的语言</li>
<li><code v-pre>data-*</code>: 为元素增加自定义属性</li>
<li><code v-pre>draggable</code>: 设置元素是否可拖拽</li>
</ul>
<h3 id="html5" tabindex="-1"><a class="header-anchor" href="#html5" aria-hidden="true">#</a> HTML5</h3>
<h4 id="什么是-doctype-及作用" tabindex="-1"><a class="header-anchor" href="#什么是-doctype-及作用" aria-hidden="true">#</a> 什么是 DOCTYPE 及作用？</h4>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>
<p>DTD: 定义文档类型，浏览器会根据它来决定用哪种协议来解析以及切换浏览器模式。</p>
</li>
<li>
<p>DOCTYPE: 是用来声明文档类型和 DTD 规范的</p>
</li>
</ul>
<p>HTML4.0 有传统模式和严格模式。</p>
<p>传统模式包含所有 HTML 元素和属性，包括展示性和弃用的元素。（如 <code v-pre>font</code>）</p>
<p>严格模式包含所有 HTML 元素和属性，但不包括展示性和弃用的元素。（如 <code v-pre>font</code>）</p>
<h4 id="html5-为什么只需要写" tabindex="-1"><a class="header-anchor" href="#html5-为什么只需要写" aria-hidden="true">#</a> HTML5 为什么只需要写 <!DOCTYPE html>？</h4>
<ul>
<li>
<p>HTML5 不基于 SGML，因此不需要对 DTD 进行引用，但是需要<code v-pre>DOCTYPE</code>来规范浏览器的行为</p>
</li>
<li>
<p>而 HTML4.01 基于 SGML，所以需要对 DTD 进行引用，才能告知浏览器所使用的文档类型</p>
</li>
</ul>
<h4 id="html5-有哪些新特性" tabindex="-1"><a class="header-anchor" href="#html5-有哪些新特性" aria-hidden="true">#</a> html5 有哪些新特性？</h4>
<p>HTML5 现在已经不是 SGML 的子集，主要是关于图像，位置，存储，多任务等功能的增加</p>
<ul>
<li>绘画 <code v-pre>canvas</code></li>
...
<li>语意化更好的内容元素，比如<code v-pre>article</code>、<code v-pre>footer</code>、<code v-pre>header</code>、<code v-pre>nav</code>、<code v-pre>section</code></li>
<li>表单控件，<code v-pre>date</code>、<code v-pre>time</code>、<code v-pre>email</code>、<code v-pre>url</code>、<code v-pre>search</code></li>
<li>新的技术<code v-pre>webworker</code>, <code v-pre>websocket</code></li>
</ul>
<h4 id="html5-有移除的元素" tabindex="-1"><a class="header-anchor" href="#html5-有移除的元素" aria-hidden="true">#</a> html5 有移除的元素?</h4>
<ul>
<li>纯表现的元素：<code v-pre>basefont</code>，<code v-pre>font</code>, <code v-pre>big</code>，<code v-pre>center</code>，<code v-pre>s</code></li>
<li>对可用性产生负面影响的元素：<code v-pre>frame</code></li>
</ul>
<h3 id="canvas-和-svg" tabindex="-1"><a class="header-anchor" href="#canvas-和-svg" aria-hidden="true">#</a> Canvas 和 SVG</h3>
<h4 id="canvas-和-svg-有什么区别" tabindex="-1"><a class="header-anchor" href="#canvas-和-svg-有什么区别" aria-hidden="true">#</a> Canvas 和 SVG 有什么区别？</h4>
<ul>
<li><code v-pre>svg</code>输出的图形是<strong>矢量图形</strong>，它绘制出来的每一个图形元素都是独立的 DOM 节点，能够方便的绑定事件或用来修改。,也可以修改参数来自由放大缩小，不会<strong>失真和有锯齿</strong>。</li>
<li>而<code v-pre>canvas</code>输出<strong>标量画布</strong>，就像一张图片一样，放大会失真或者锯齿</li>
</ul>
<hr>
<h2 id="css" tabindex="-1"><a class="header-anchor" href="#css" aria-hidden="true">#</a> CSS:</h2>
<h3 id="css-单位" tabindex="-1"><a class="header-anchor" href="#css-单位" aria-hidden="true">#</a> css 单位</h3>
<h4 id="解释一下-css-里的两个单位-em-和-rem-你一般怎么使用它们" tabindex="-1"><a class="header-anchor" href="#解释一下-css-里的两个单位-em-和-rem-你一般怎么使用它们" aria-hidden="true">#</a> 解释一下 CSS 里的两个单位：em 和 rem，你一般怎么使用它们？</h4>
<p>1em，等于本元素的字体大小，所以在不同的元素里1em的绝对大小是不一样的。</p>
<p>而1rem，等于根元素的字体大小，在一个页面中，无论在哪个元素上1rem都是一样的。</p>
<p>em 适合于用在需要大小需要跟随字体变化的属性上，比如padding、margin、height、width等等，元素继承了不同的字体大小，这些属性最好也能跟着变化；
大多数人可能会认为 em 相对于父元素的字体大小，但是实际上取决于应用在什么 CSS 属性上。对于 font-size 来说，em 相对于父元素的字体大小；line-height 中，em 却相对于自身字体的大小。</p>
<p>rem适用于字体，这样就可以通过改变根元素的字体大小来改变整个页面的字体大小。</p>
<h4 id="px-em-rem-的区别" tabindex="-1"><a class="header-anchor" href="#px-em-rem-的区别" aria-hidden="true">#</a> px， em， rem 的区别？</h4>
<ul>
<li>px是相对长度单位。像素px是相对于显示器屏幕分辨率而言的。</li>
<li>em是相对长度单位。相对于当前对象内文本的字体尺寸;（参考物是父元素的font-size）。如当前父元素的字体尺寸未设置，则相对于浏览器的默认字体尺寸</li>
<li>rem是相对于HTML根元素的字体大小（font-size）来计算的长度单位。</li>
</ul>
<h4 id="相对于谁" tabindex="-1"><a class="header-anchor" href="#相对于谁" aria-hidden="true">#</a> % 相对于谁</h4>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">.wp</span> <span class="token punctuation">{</span>
...
<li>第一处 50% 是指 .wrap 相对定位元素宽度和高度的 50%，而 <code v-pre>transform</code> 中的 50% 是指自身元素的宽高的一半。</li>
<li>对于设置绝对定位 <code v-pre>position absolute</code> 的元素，我们可以使用 <code v-pre>left</code> <code v-pre>right</code> 表示其偏移量，我们把这个元素的祖先元素中第一个存在定位属性的元素成为参照物元素，其中的 % 是相对于参照物的，<code v-pre>left</code> 相对于参照物的 <code v-pre>width</code>，<code v-pre>top</code> 相对于这个参照物的 <code v-pre>height</code>。</li>
<li>对于设置相对定位 <code v-pre>position relative</code> 的元素，% 的数值是相对与自身的，left 相对于自己的 width，top 相对于自己的 height。</li>
<li>对于设置固定定位 <code v-pre>position fixed</code> 的元素，% 的数值是相对于视口的，left 相对于视口的 width，top 相对于视口的 height。</li>
<li><code v-pre>margin</code> 和 <code v-pre>padding</code> 当中的 % 非常特殊，它是相对于父元素的宽度。没错，<code v-pre>margin-top: 30%</code>，相当于父元素宽度的 30%。</li>
<li><code v-pre>font-size</code> 的 %相对于父元素的字体大小。</li>
<li><code v-pre>line-height</code> 设置行高时，如果单位为 %，则相对于该元素的 <code v-pre>font-size</code> 数值。</li>
<li><code v-pre>text-indent</code> 这个属性可以设置首行缩进，当使用 % 时，它是相对于父元素的 <code v-pre>width</code>。</li>
<li><code v-pre>border-radius: 50%</code>得到一个圆形，因此不难发现这里的 % 也是相对于自身宽高的。</li>
<li><code v-pre>background-size</code> 的百分比和 <code v-pre>border-radius</code> 一样，也是相对于自身的宽高。</li>
<li><code v-pre>transform</code> 的 <code v-pre>translate</code> 属性 % 是相对于自身的宽高，这也是我们上述代码能够实现居中的原因。</li>
</ul>
<h3 id="布局方式" tabindex="-1"><a class="header-anchor" href="#布局方式" aria-hidden="true">#</a> 布局方式</h3>
<h4 id="什么是flex-写出常见属性-以及作用" tabindex="-1"><a class="header-anchor" href="#什么是flex-写出常见属性-以及作用" aria-hidden="true">#</a> 什么是flex？写出常见属性，以及作用？</h4>
<p>flex：弹性布局。</p>
<p>常见属性及作用：</p>
<ul>
...
<h4 id="display-有哪些值-说明他们的作用" tabindex="-1"><a class="header-anchor" href="#display-有哪些值-说明他们的作用" aria-hidden="true">#</a> display 有哪些值？说明他们的作用？</h4>
<ul>
<li>none：  元素不会被显示</li>
<li>block： 此元素将显示为块级元素，此元素前后会带有换行符。</li>
<li>inline： 默认。此元素会被显示为内联元素，元素前后没有换行符。</li>
<li>inline-block： 像行内元素一样显示，但其内容像块类型元素一样显示。可以设置宽高，可以设置margin和padding。</li>
<li>flex： 弹性盒子布局</li>
<li>inline-flex：内联的弹性盒子布局</li>
<li>table： 此元素会作为块级表格来显示（类似 <code v-pre>&lt;table&gt;</code>），表格前后带有换行符。</li>
<li>inline-table：	此元素会作为内联表格来显示（类似 <code v-pre>&lt;table&gt;</code>），表格前后没有换行符。</li>
<li>table-row： 此元素会作为一个表格行显示（类似 <code v-pre>&lt;tr&gt;</code>）。</li>
<li>table-cell：此元素会作为一个表格单元格显示（类似 <code v-pre>&lt;td&gt;</code> 和 <code v-pre>&lt;th&gt;</code>）</li>
<li>grid： 网格布局</li>
<li>inherit 规定应该从父元素继承 display 属性的值。</li>
</ul>
<h4 id="隐藏一个元素有多少种方法" tabindex="-1"><a class="header-anchor" href="#隐藏一个元素有多少种方法" aria-hidden="true">#</a> 隐藏一个元素有多少种方法？</h4>
<ol>
<li><code v-pre>display:none;</code></li>
<li><code v-pre>opacity:0;</code></li>
<li><code v-pre>visibility：hidden;</code></li>
<li><code v-pre>position:absolute;clip(0,0,0,0);</code></li>
<li><code v-pre>overflow:hidden;</code></li>
<li><code v-pre>width: 0px;height: 0px;</code></li>
</ol>
<h4 id="display-none-与-visibility-hidden区别在哪" tabindex="-1"><a class="header-anchor" href="#display-none-与-visibility-hidden区别在哪" aria-hidden="true">#</a> <code v-pre>display: none</code> 与 <code v-pre>visibility: hidden</code>区别在哪？</h4>
<p>联系：它们都能让元素不可见</p>
<p>区别：</p>
<ol>
<li><code v-pre>display:none</code>会让元素完全从渲染树中消失，渲染的时候<strong>不占据任何空间</strong>；<code v-pre>visibility: hidden</code>不会让元素从渲染树消失，渲染元素<strong>继续占据空间</strong>，只是内容不可见</li>
<li><code v-pre>display: none</code>是<strong>非继承属性</strong>，子孙节点消失由于元素从渲染树消失造成，通过修改子孙节点属性无法显示；<code v-pre>visibility: hidden</code><strong>是继承属性</strong>，子孙节点消失由于继承了 hidden，通过设置<code v-pre>visibility: visible</code>可以让子孙节点显示</li>
<li>修改常规流中元素的<code v-pre>display</code>通常会造成文档<strong>回流</strong>。修改<code v-pre>visibility</code>属性只会造成本元素的<strong>重绘</strong>。</li>
<li><strong>读屏器</strong>不会读取<code v-pre>display: none</code>元素内容；会读取<code v-pre>visibility: hidden</code>元素内容</li>
</ol>
<h3 id="浮动" tabindex="-1"><a class="header-anchor" href="#浮动" aria-hidden="true">#</a> 浮动</h3>
<h4 id="行内元素float-left后是否变为块级元素" tabindex="-1"><a class="header-anchor" href="#行内元素float-left后是否变为块级元素" aria-hidden="true">#</a> 行内元素<code v-pre>float:left</code>后是否变为块级元素？</h4>
<p>浮动后，行内元素不会成为块状元素，但是可以设置宽高。行内元素要想变成块状元素，占一行，直接设置<code v-pre>display:block</code>。但如果元素设置了浮动后再设置<code v-pre>display:block</code>那就不会占一行</p>
<h4 id="为什么要清除浮动" tabindex="-1"><a class="header-anchor" href="#为什么要清除浮动" aria-hidden="true">#</a> 为什么要清除浮动？</h4>
<p>不清除浮动会发生高度塌陷：父元素不写高度时，子元素写了浮动后，父元素会发生高度塌陷。</p>
<h4 id="清除浮动有几种方式" tabindex="-1"><a class="header-anchor" href="#清除浮动有几种方式" aria-hidden="true">#</a> 清除浮动有几种方式？</h4>
<ol>
<li>
<p>添加空 div，在浮动元素下方添加空 div，并给该元素写 CSS 样式<code v-pre>clear:both</code></p>
<ul>
<li>优点： 简单，代码少，浏览器支持好，不容易出现怪问题</li>
<li>缺点： 页面浮动布局多，就要增加很多空 div</li>
</ul>
</li>
<li>
<p>父级设置高度</p>
...
<li>
<p>给父级添加<code v-pre>overflow:hidden</code> 清除浮动方法</p>
<ul>
<li>优点： 简单，代码少，浏览器支持好</li>
<li>缺点： 不能和 position 配合使用，因为超出的尺寸的会被隐藏</li>
</ul>
</li>
<li>
<p>父级元素定义 after 伪类 （现在主流方法，推荐使用）</p>
<ul>
<li>优点： 浏览器支持好，不容易出现怪问题</li>
<li>缺点： 代码多</li>
</ul>
</li>
</ol>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">.fix:after</span> <span class="token punctuation">{</span>
  <span class="token property">content</span><span class="token punctuation">:</span> <span class="token string">''</span><span class="token punctuation">;</span>
  <span class="token property">display</span><span class="token punctuation">:</span> table<span class="token punctuation">;</span>
  <span class="token property">clear</span><span class="token punctuation">:</span> both<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
<span class="token selector">//兼容ie6,7
.fix</span> <span class="token punctuation">{</span>
  *<span class="token property">zoom</span><span class="token punctuation">:</span> 1<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="css-盒模型" tabindex="-1"><a class="header-anchor" href="#css-盒模型" aria-hidden="true">#</a> CSS 盒模型</h3>
<h4 id="介绍一下标准的-css-的盒子模型-低版本-ie-的盒子模型有什么不同的" tabindex="-1"><a class="header-anchor" href="#介绍一下标准的-css-的盒子模型-低版本-ie-的盒子模型有什么不同的" aria-hidden="true">#</a> 介绍一下标准的 CSS 的盒子模型？低版本 IE 的盒子模型有什么不同的？</h4>
<ul>
<li>
<p>标准模型<code v-pre>width</code>不计算<code v-pre>padding</code>和<code v-pre>border</code></p>
</li>
<li>
<p>IE 模型<code v-pre>width</code>计算<code v-pre>padding</code>和<code v-pre>border</code>。</p>
</li>
</ul>
<p><code v-pre>box-sizing</code> : <code v-pre>content-box</code>(标准模型-默认)/<code v-pre>border-box</code>(IE 模型)</p>
<h4 id="js-中如何获取盒模型宽高" tabindex="-1"><a class="header-anchor" href="#js-中如何获取盒模型宽高" aria-hidden="true">#</a> js 中如何获取盒模型宽高?</h4>
<ol>
<li>
<p><code v-pre>dom.style.width</code>（只能取内联宽高)</p>
</li>
<li>
<p><code v-pre>dom.currentStyle.width</code> (浏览器渲染之后的取值，只有 IE 支持)</p>
</li>
<li>
<p><code v-pre>window.getComputedStyle(dom).width</code> (浏览器渲染之后的取值，兼容性更好)</p>
</li>
<li>
<p><code v-pre>dom.getBoundingClientRect().width/height/left/top</code> (常用于计算位置)</p>
</li>
</ol>
<h3 id="bfc" tabindex="-1"><a class="header-anchor" href="#bfc" aria-hidden="true">#</a> BFC</h3>
<h4 id="什么是-bfc-概念" tabindex="-1"><a class="header-anchor" href="#什么是-bfc-概念" aria-hidden="true">#</a> 什么是 BFC?(概念)</h4>
<p>块级格式化上下文</p>
<h4 id="对-bfc-规范的理解" tabindex="-1"><a class="header-anchor" href="#对-bfc-规范的理解" aria-hidden="true">#</a> 对 BFC 规范的理解？</h4>
<p>它决定了元素如何对其内容进行定位，以及与其他元素的关系和相互作用</p>
<h4 id="bfc-的原理" tabindex="-1"><a class="header-anchor" href="#bfc-的原理" aria-hidden="true">#</a> BFC 的原理？</h4>
<ol>
<li>
<p>同一BFC内块级元素之间的垂直方向边距会发生重叠。</p>
</li>
<li>
<p>浮动元素区域不会与 BFC 重叠</p>
</li>
<li>
<p>BFC 在页面上是一个独立的容器，外面的元素不会影响里面的元素，里面的元素也不会影响外面的元素</p>
</li>
<li>
<p>计算 BFC 高度时，浮动元素也会参与计算</p>
</li>
</ol>
<h4 id="如何创建-bfc" tabindex="-1"><a class="header-anchor" href="#如何创建-bfc" aria-hidden="true">#</a> 如何创建 BFC？</h4>
<ul>
<li><code v-pre>&lt;html&gt;</code> 根元素。</li>
<li><code v-pre>float</code> 的值不为 <code v-pre>none</code> 。</li>
<li><code v-pre>overflow</code> 值不为 <code v-pre>visible</code> 的块元素。</li>
<li>绝对定位元素（元素的 <code v-pre>position</code> 为 <code v-pre>absolute</code> 或 <code v-pre>fixed</code>）</li>
<li><code v-pre>display</code> 的值为 <code v-pre>table-cell</code>、 <code v-pre>table-caption</code> 和 <code v-pre>inline-block</code> 中的任何一个。</li>
</ul>
<h4 id="bfc-使用场景" tabindex="-1"><a class="header-anchor" href="#bfc-使用场景" aria-hidden="true">#</a> BFC 使用场景?</h4>
<ol>
<li>
<p>解决垂直方向的边距重叠</p>
</li>
...
<h3 id="重绘-repaint-和回流-reflow" tabindex="-1"><a class="header-anchor" href="#重绘-repaint-和回流-reflow" aria-hidden="true">#</a> 重绘（Repaint）和回流（Reflow）</h3>
<p>重绘和回流会在我们设置节点样式时频繁出现，同时也会很大程度上影响性能。</p>
<h4 id="重绘与回流" tabindex="-1"><a class="header-anchor" href="#重绘与回流" aria-hidden="true">#</a> 重绘与回流</h4>
<ul>
<li>
<p>重绘(Repaint)是当节点需要更改外观而不会影响布局的，比如改变 <code v-pre>color</code> 就叫称为重绘</p>
</li>
<li>
<p>回流(Reflow)是布局或者几何属性需要改变就称为回流。</p>
</li>
</ul>
<p>回流必定会发生重绘，重绘不一定会引发回流。回流所需的成本比重绘高的多，改变父节点里的子节点很可能会导致父节点的一系列回流。</p>
<p><strong>以下几个动作可能会导致性能问题：</strong></p>
<ul>
<li>改变 <code v-pre>window</code> 大小</li>
<li>改变字体</li>
<li>添加或删除样式</li>
<li>文字改变</li>
<li>定位或者浮动</li>
...
<ol>
<li>当 Eventloop 执行完 Microtasks（微任务） 后，会判断 <code v-pre>document</code> 是否需要更新，因为浏览器是 60Hz 的刷新率，每 16.6ms 才会更新一次。</li>
<li>然后判断是否有 <code v-pre>resize</code> 或者 <code v-pre>scroll</code> 事件，有的话会去触发事件，所以 <code v-pre>resize</code> 和 <code v-pre>scroll</code> 事件也是至少 16ms 才会触发一次，并且自带节流功能。</li>
<li>判断是否触发了 media query(媒体查询)</li>
<li>更新动画并且发送事件</li>
<li>判断是否有全屏操作事件</li>
<li>执行 <code v-pre>requestAnimationFrame</code> 回调</li>
<li>执行 <code v-pre>IntersectionObserver</code> 回调，该方法用于判断元素是否可见，可以用于懒加载上，但是兼容性不好</li>
<li>更新界面</li>
<li>以上就是一帧中可能会做的事情。如果在一帧中有空闲时间，就会去执行 <code v-pre>requestIdleCallback</code> 回调。</li>
</ol>
<p>以上内容来自于 <a href="https://html.spec.whatwg.org/multipage/webappapis.html#event-loop-processing-model" target="_blank" rel="noopener noreferrer">HTML 文档<ExternalLinkIcon/></a>。</p>
<h4 id="减少-重绘与回流" tabindex="-1"><a class="header-anchor" href="#减少-重绘与回流" aria-hidden="true">#</a> 减少 重绘与回流</h4>
<ol>
<li>使用 <code v-pre>transform</code> 替代 <code v-pre>top</code></li>
<li>使用 <code v-pre>visibility</code> 替换 <code v-pre>display: none</code> (前者只会引起重绘，后者会引发回流)</li>
...
<li>不要使用 <code v-pre>table</code> 布局，可能很小的一个小改动会造成整个 <code v-pre>table</code> 的重新布局</li>
<li>动画实现的速度的选择，动画速度越快，回流次数越多，可以选择使用 <code v-pre>requestAnimationFrame</code></li>
<li>CSS 选择符<strong>从右往左</strong>匹配查找，避免节点层级过多</li>
<li>将频繁重绘或者回流的节点设置为图层，图层能够阻止该节点的渲染行为影响别的节点。比如对于 <code v-pre>video</code> 标签来说，浏览器会自动将该节点变为图层;
以下常用属性可以生成新图层:
<ul>
<li><code v-pre>will-change</code></li>
<li><code v-pre>video、iframe</code> 标签</li>
</ul>
</li>
<li>不要重复添加 DOM， 如果有多个操作合并在一起添加到页面</li>
</ol>
<h3 id="fouc" tabindex="-1"><a class="header-anchor" href="#fouc" aria-hidden="true">#</a> FOUC</h3>
<h4 id="什么是-fouc-如何避免" tabindex="-1"><a class="header-anchor" href="#什么是-fouc-如何避免" aria-hidden="true">#</a> 什么是 FOUC?如何避免?</h4>
<p><code v-pre>Flash Of Unstyled Content</code>：用户定义样式表加载之前浏览器使用默认样式显示文档，CSS 样式加载后再次渲染文档，造成页面闪烁。</p>
<p>解决方法：把样式表放到文档的 head</p>
<h3 id="css-sprite" tabindex="-1"><a class="header-anchor" href="#css-sprite" aria-hidden="true">#</a> css sprite</h3>
<h4 id="css-sprite-是什么-有什么优缺点" tabindex="-1"><a class="header-anchor" href="#css-sprite-是什么-有什么优缺点" aria-hidden="true">#</a> css sprite 是什么,有什么优缺点</h4>
<p>概念：将多个小图片拼接到一个图片中。通过<code v-pre>background-position</code>和元素尺寸调节显示需要的背景图案。</p>
<p>优点：</p>
<ul>
<li>减少 HTTP 请求数，提高页面加载速度</li>
<li>减少图片大小</li>
...
<h4 id="css3" tabindex="-1"><a class="header-anchor" href="#css3" aria-hidden="true">#</a> CSS3</h4>
<h4 id="css3-有哪些新特性" tabindex="-1"><a class="header-anchor" href="#css3-有哪些新特性" aria-hidden="true">#</a> CSS3 有哪些新特性</h4>
<ul>
<li>新增各种 CSS 选择器</li>
<li>边框圆角 <code v-pre>border-radius</code></li>
<li>多列布局</li>
<li>阴影和反射</li>
<li>文字特效<code v-pre>text-shadow</code></li>
<li>线性渐变</li>
<li>旋转<code v-pre>transform</code></li>
<li>过渡<code v-pre>transition</code></li>
<li>动画<code v-pre>animation</code></li>
</ul>
<h4 id="css3-新增伪类有那些" tabindex="-1"><a class="header-anchor" href="#css3-新增伪类有那些" aria-hidden="true">#</a> CSS3 新增伪类有那些？</h4>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code>* <span class="token property">p</span><span class="token punctuation">:</span>first-of-type 选择属于其父元素的首个&lt;p>元素的每个&lt;p> 元素。
...
* <span class="token punctuation">:</span>before 在元素之前添加内容
* <span class="token punctuation">:</span>after 在元素之后添加内容<span class="token punctuation">,</span>也可以用来做清除浮动。
* <span class="token punctuation">:</span>enabled 选择器匹配每个启用的的元素（主要用于表单元素）。
* <span class="token punctuation">:</span>disabled 控制表单控件的禁用状态。
* <span class="token punctuation">:</span>checked 单选框或复选框被选中
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="笔试题" tabindex="-1"><a class="header-anchor" href="#笔试题" aria-hidden="true">#</a> 笔试题</h3>
<h4 id="如何用-css-实现一行文字后面-的情况" tabindex="-1"><a class="header-anchor" href="#如何用-css-实现一行文字后面-的情况" aria-hidden="true">#</a> 如何用 css 实现一行文字后面...的情况?</h4>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token property">overflow</span><span class="token punctuation">:</span> hidden<span class="token punctuation">;</span> //超出隐藏
<span class="token property">white-space</span><span class="token punctuation">:</span> nowrap<span class="token punctuation">;</span> //不允许换行
<span class="token property">text-overflow</span><span class="token punctuation">:</span> ellipsis<span class="token punctuation">;</span> //超出部分用...代替
//多行的情况请添加如下设置
<span class="token property">display</span><span class="token punctuation">:</span> -webkit-box<span class="token punctuation">;</span>
<span class="token property">-webkit-line-clamp</span><span class="token punctuation">:</span> 1<span class="token punctuation">;</span> //多行情况下可以设置哪一行多余部分用...代替。这里设置的是第一行
<span class="token property">-webkit-box-orient</span><span class="token punctuation">:</span> vertical<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="css3-如何实现-0-5px-的细线" tabindex="-1"><a class="header-anchor" href="#css3-如何实现-0-5px-的细线" aria-hidden="true">#</a> css3 如何实现 0.5px 的细线?</h4>
...
<span class="token selector">.line:after</span> <span class="token punctuation">{</span>
  ...
  <span class="token property">transform</span><span class="token punctuation">:</span> <span class="token function">scaleY</span><span class="token punctuation">(</span>0.5<span class="token punctuation">)</span><span class="token punctuation">;</span> //在Y轴缩小一半
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>line<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="css-如何实现三角形" tabindex="-1"><a class="header-anchor" href="#css-如何实现三角形" aria-hidden="true">#</a> css 如何实现三角形?</h4>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="宽高已知-如何实现-div-水平垂直居中" tabindex="-1"><a class="header-anchor" href="#宽高已知-如何实现-div-水平垂直居中" aria-hidden="true">#</a> 宽高已知，如何实现 div 水平垂直居中?</h4>
<h5 id="第一种方案" tabindex="-1"><a class="header-anchor" href="#第一种方案" aria-hidden="true">#</a> 第一种方案</h5>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="第二种方案" tabindex="-1"><a class="header-anchor" href="#第二种方案" aria-hidden="true">#</a> 第二种方案</h5>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">.box</span> <span class="token punctuation">{</span>
  <span class="token property">height</span><span class="token punctuation">:</span> 200px<span class="token punctuation">;</span>
  <span class="token property">position</span><span class="token punctuation">:</span> relative<span class="token punctuation">;</span>
  <span class="token property">background</span><span class="token punctuation">:</span> red<span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>content<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>水平垂直居中<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="宽高未知-如何实现-div-水平垂直居中" tabindex="-1"><a class="header-anchor" href="#宽高未知-如何实现-div-水平垂直居中" aria-hidden="true">#</a> 宽高未知，如何实现 div 水平垂直居中?</h4>
<h5 id="第一种方案-1" tabindex="-1"><a class="header-anchor" href="#第一种方案-1" aria-hidden="true">#</a> 第一种方案</h5>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">.box</span> <span class="token punctuation">{</span>
  <span class="token property">width</span><span class="token punctuation">:</span> 400px<span class="token punctuation">;</span>
  <span class="token property">height</span><span class="token punctuation">:</span> 200px<span class="token punctuation">;</span>
  <span class="token property">position</span><span class="token punctuation">:</span> relative<span class="token punctuation">;</span>
...
<span class="token selector">.content</span> <span class="token punctuation">{</span>
  ...
  <span class="token property">background</span><span class="token punctuation">:</span> green<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="flex-解决方案" tabindex="-1"><a class="header-anchor" href="#flex-解决方案" aria-hidden="true">#</a> flex 解决方案:</h5>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">.box</span> <span class="token punctuation">{</span>
  <span class="token property">width</span><span class="token punctuation">:</span> 400px<span class="token punctuation">;</span>
  <span class="token property">height</span><span class="token punctuation">:</span> 200px<span class="token punctuation">;</span>
  <span class="token property">background</span><span class="token punctuation">:</span> red<span class="token punctuation">;</span>
...
<span class="token selector">.content</span> <span class="token punctuation">{</span>
  ...
  <span class="token property">background</span><span class="token punctuation">:</span> green<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="假设高度已知-请写出三栏布局-圣杯布局-其中左栏、右栏宽度各为-100px-中间自适应" tabindex="-1"><a class="header-anchor" href="#假设高度已知-请写出三栏布局-圣杯布局-其中左栏、右栏宽度各为-100px-中间自适应" aria-hidden="true">#</a> 假设高度已知，请写出三栏布局(圣杯布局)，其中左栏、右栏宽度各为 100px，中间自适应</h4>
<p>以下布局如果条件是高度未知,依然适用的布局有 flex, table 布局。</p>
<ul>
<li>
<p>浮动:</p>
<ul>
<li>
<p>缺点：脱离文档流，需清除浮动。处理不好会带来很多问题。</p>
</li>
<li>
<p>优点：兼容性好。</p>
</li>
...
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">&lt;style>
    .box1 div</span><span class="token punctuation">{</span>
      <span class="token property">min-height</span><span class="token punctuation">:</span> 50px<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box1 .left</span><span class="token punctuation">{</span>
        <span class="token property">float</span><span class="token punctuation">:</span> left<span class="token punctuation">;</span>
        <span class="token property">width</span><span class="token punctuation">:</span> 100px<span class="token punctuation">;</span>
        <span class="token property">background</span><span class="token punctuation">:</span> red<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box1 .right</span><span class="token punctuation">{</span>
        <span class="token property">float</span><span class="token punctuation">:</span> right<span class="token punctuation">;</span>
        <span class="token property">width</span><span class="token punctuation">:</span> 100px<span class="token punctuation">;</span>
        <span class="token property">background</span><span class="token punctuation">:</span> green<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box1 .center</span><span class="token punctuation">{</span>
        <span class="token property">background</span><span class="token punctuation">:</span> yellow<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
&lt;/style>
&lt;section class=<span class="token string">"box1"</span>>
    &lt;div class=<span class="token string">"left"</span>>&lt;/div>
    &lt;div class=<span class="token string">"right"</span>>&lt;/div>
    &lt;div class=<span class="token string">"center"</span>>浮动自适应部分&lt;/div>
&lt;/section>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>
<p>绝对定位:</p>
<ul>
<li>
<p>缺点：绝对定位脱离文档流，导致了其子元素都脱离了文档流，可使用性很差。</p>
</li>
<li>
<p>优点：快捷！</p>
</li>
...
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">&lt;style>
    .box2</span><span class="token punctuation">{</span>
        <span class="token property">min-height</span><span class="token punctuation">:</span> 50px<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box2 div</span><span class="token punctuation">{</span>
        <span class="token property">position</span><span class="token punctuation">:</span> absolute<span class="token punctuation">;</span>
        <span class="token property">min-height</span><span class="token punctuation">:</span> 50px<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box2 .left</span><span class="token punctuation">{</span>
        <span class="token property">width</span><span class="token punctuation">:</span> 100px<span class="token punctuation">;</span>
        <span class="token property">left</span><span class="token punctuation">:</span> 0<span class="token punctuation">;</span>
        <span class="token property">background</span><span class="token punctuation">:</span> red<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box2 .center</span><span class="token punctuation">{</span>
        ...
        <span class="token property">background</span><span class="token punctuation">:</span> yellow<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box2 .right</span><span class="token punctuation">{</span>
        <span class="token property">right</span><span class="token punctuation">:</span> 0<span class="token punctuation">;</span>
        <span class="token property">width</span><span class="token punctuation">:</span> 100px<span class="token punctuation">;</span>
        <span class="token property">background</span><span class="token punctuation">:</span> green<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
&lt;/style>
&lt;section class=<span class="token string">"box2"</span>>
    &lt;div class=<span class="token string">"left"</span>> &lt;/div>
    &lt;div class=<span class="token string">"center"</span>>绝对定位自适应部分&lt;/div>
    &lt;div class=<span class="token string">"right"</span>>&lt;/div>
&lt;/section>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>
...
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">&lt;style>
    .box3</span><span class="token punctuation">{</span>
        ...
        <span class="token property">min-height</span><span class="token punctuation">:</span> 50px<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box3 .left</span><span class="token punctuation">{</span>
        <span class="token property">width</span><span class="token punctuation">:</span> 100px<span class="token punctuation">;</span>
        <span class="token property">background</span><span class="token punctuation">:</span> red<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box3 .center</span><span class="token punctuation">{</span>
        <span class="token property">flex</span><span class="token punctuation">:</span> 1<span class="token punctuation">;</span>
        <span class="token property">background</span><span class="token punctuation">:</span> yellow<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box3 .right</span><span class="token punctuation">{</span>
        <span class="token property">width</span><span class="token punctuation">:</span> 100px<span class="token punctuation">;</span>
        <span class="token property">background</span><span class="token punctuation">:</span> green<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>

&lt;/style>
&lt;section class=<span class="token string">"box3"</span>>
    &lt;div class=<span class="token string">"left"</span>>&lt;/div>
    &lt;div class=<span class="token string">"center"</span>>flex自适应部分&lt;/div>
    &lt;div class=<span class="token string">"right"</span>>&lt;/div>
&lt;/section>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>
...
<ul>
<li>
<p>缺点：多栏布局时，某个单元格高度超出，会使其他单元格高度一起增加。操作繁琐，SEO 不友好。</p>
</li>
<li>
<p>优点：兼容性好，兼容 ie8。</p>
</li>
...
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">&lt;style>
    .box4</span> <span class="token punctuation">{</span>
        <span class="token property">display</span><span class="token punctuation">:</span> table<span class="token punctuation">;</span>
        <span class="token property">width</span><span class="token punctuation">:</span> 100%<span class="token punctuation">;</span>
        <span class="token property">min-height</span><span class="token punctuation">:</span> 50px<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box4 div</span><span class="token punctuation">{</span>
        <span class="token property">display</span><span class="token punctuation">:</span> table-cell<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box4 .left</span><span class="token punctuation">{</span>
        <span class="token property">width</span><span class="token punctuation">:</span> 100px<span class="token punctuation">;</span>
        <span class="token property">min-height</span><span class="token punctuation">:</span> 50px<span class="token punctuation">;</span>
        <span class="token property">background</span><span class="token punctuation">:</span> red<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box4 .center</span><span class="token punctuation">{</span>
        <span class="token property">min-height</span><span class="token punctuation">:</span> 50px<span class="token punctuation">;</span>
        <span class="token property">background</span><span class="token punctuation">:</span> yellow<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box4 .right</span><span class="token punctuation">{</span>
        <span class="token property">width</span><span class="token punctuation">:</span> 100px<span class="token punctuation">;</span>
        <span class="token property">min-height</span><span class="token punctuation">:</span> 50px<span class="token punctuation">;</span>
        <span class="token property">background</span><span class="token punctuation">:</span> green<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
&lt;/style>
&lt;section class=<span class="token string">"box4"</span>>
    &lt;div class=<span class="token string">"left"</span>>&lt;/div>
    &lt;div class=<span class="token string">"center"</span>>表格自适应部分&lt;/div>
    &lt;div class=<span class="token string">"right"</span>>&lt;/div>
&lt;/section>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>
...
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">&lt;style>
    .box5</span><span class="token punctuation">{</span>
        <span class="token property">display</span><span class="token punctuation">:</span> grid<span class="token punctuation">;</span>
        <span class="token property">width</span><span class="token punctuation">:</span> 100%<span class="token punctuation">;</span>
        <span class="token property">grid-template-rows</span><span class="token punctuation">:</span>50px<span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
    <span class="token selector">.box5 .left</span><span class="token punctuation">{</span>
        <span class="token property">background</span><span class="token punctuation">:</span> red<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box5 .center</span><span class="token punctuation">{</span>
        <span class="token property">background</span><span class="token punctuation">:</span> yellow<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">.box5 .right</span><span class="token punctuation">{</span>
        <span class="token property">background</span><span class="token punctuation">:</span> green<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
&lt;/style>
&lt;section class=<span class="token string">"box5"</span>>
    &lt;div class=<span class="token string">"left"</span>>&lt;/div>
    &lt;div class=<span class="token string">"center"</span>>网格自适应部分&lt;/div>
    &lt;div class=<span class="token string">"right"</span>>&lt;/div>
&lt;/section>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="如何实现下图九宫格的效果-鼠标滑过边框显示红色" tabindex="-1"><a class="header-anchor" href="#如何实现下图九宫格的效果-鼠标滑过边框显示红色" aria-hidden="true">#</a> 如何实现下图九宫格的效果?鼠标滑过边框显示红色?</h4>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1587617549626.png" alt="示例"></p>
...
<span class="token selector">.wrap li</span> <span class="token punctuation">{</span>
  ...
  <span class="token property">justify-content</span><span class="token punctuation">:</span> center<span class="token punctuation">;</span>
  <span class="token property">align-items</span><span class="token punctuation">:</span> center<span class="token punctuation">;</span>
  <span class="token property">border</span><span class="token punctuation">:</span> 4px solid #ccc<span class="token punctuation">;</span>
...
<span class="token selector">.wrap li:nth-child(3n + 1)</span> <span class="token punctuation">{</span>
  <span class="token property">margin-left</span><span class="token punctuation">:</span> 0<span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token selector">.wrap li:nth-child(1),
.wrap li:nth-child(2),
.wrap li:nth-child(3)</span> <span class="token punctuation">{</span>
  <span class="token property">margin-top</span><span class="token punctuation">:</span> 0<span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token selector">.wrap li:hover</span> <span class="token punctuation">{</span>
...
<blockquote>
<p>另外对于 <code v-pre>null</code> 来说，很多人会认为他是个对象类型，其实这是错误的。虽然 <code v-pre>typeof null</code> 会输出 <code v-pre>object</code>，但是这只是 JS 存在的一个悠久 Bug。在 JS 的最初版本中使用的是 32 位系统，为了性能考虑使用低位存储变量的类型信息，000 开头代表是对象，然而 null 表示为全零，所以将它错误的判断为 <code v-pre>object</code> 。虽然现在的内部类型判断代码已经改变了，但是对于这个 Bug 却是一直流传下来。</p>
</blockquote>
...
<ul>
<li>
<p><code v-pre>null</code>表示空对象指针</p>
<ul>
<li>如果定义的变量准备用来保存对象，那么最好初始化为<code v-pre>null</code></li>
</ul>
</li>
<li>
<p><code v-pre>undefined</code>表示未赋值的变量</p>
</li>
<li>
<p>在使用<code v-pre>==</code>会发生类型转换.导致相等</p>
</li>
</ul>
...
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1584178443591.png" alt="类型转换表格"></p>
...
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1584320285922.png" alt="==运算流程分析"></p>
...
<p><code v-pre>childNodes</code> 属性返回所有的节点，包括文本节点、注释节点；
<code v-pre>children</code> 属性只返回元素节点；</p>
...
<p>一个函数的父级作用域是在它定义的时候的作用域，而非它执行时候的作用域。</p>
</div>
<p>作用域其实就是代表了一个变量合法的使用范围。如果超出了范围就会报错。</p>
<p>作用域分为局部作用域和全局作用域，处在局部作用域里面可以访问到全局作用域的变量，而在局部作用域外面就访问不到局部作用域里面所声明的变量。</p>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1582641721107.png" alt="enter description here"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="this全解析" tabindex="-1"><a class="header-anchor" href="#this全解析" aria-hidden="true">#</a> this全解析</h3>
<div class="custom-container tip">
<p class="custom-container-title">Tips</p>
...
<h4 id="以下代码this指向谁" tabindex="-1"><a class="header-anchor" href="#以下代码this指向谁" aria-hidden="true">#</a> 以下代码this指向谁？</h4>
...
<span class="token keyword">var</span> obj <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
obj<span class="token punctuation">.</span><span class="token function">method</span><span class="token punctuation">(</span>fn<span class="token punctuation">,</span><span class="token string">'l'</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>第一次打印1， 此时 <code v-pre>this</code> 指向 <code v-pre>window</code> , <code v-pre>window.length</code> 指的是 <code v-pre>frame</code> <code v-pre>iframe</code>的窗口数量。</p>
<p>第二次打印2， 此时 <code v-pre>this</code> 指向 <code v-pre>arguments</code> 对象。 此时 <code v-pre>arguments</code> 参数长度是2。</p>
...
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1587033507396.png" alt="原型图"></p>
...
</code></pre><div class="highlight-lines"><br><br><br><br><div class="highlight-line">&nbsp;</div><br><br><div class="highlight-line">&nbsp;</div><br><br><br><br></div><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>原型链继承:
<ul>
...
<h4 id="面向对象有哪几种设计模式" tabindex="-1"><a class="header-anchor" href="#面向对象有哪几种设计模式" aria-hidden="true">#</a> 面向对象有哪几种设计模式？</h4>
<p>基本特征：多态，继承，封包（完全参考 java）</p>
<ul>
<li>
<p>工厂模式:</p>
<ul>
<li>
<p>在函数中创建一个对象，给对象添加属性或属性方法，然后在把这个对象用<strong>return</strong>返回出来</p>
</li>
<li>
<p>优点: 解决重复实例化</p>
</li>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">createPerson</span><span class="token punctuation">(</span><span class="token parameter">name<span class="token punctuation">,</span> age</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
<span class="token keyword">var</span> xm <span class="token operator">=</span> <span class="token function">createPerson</span><span class="token punctuation">(</span><span class="token string">'xm'</span><span class="token punctuation">,</span> <span class="token string">'23'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">var</span> xh <span class="token operator">=</span> <span class="token function">createPerson</span><span class="token punctuation">(</span><span class="token string">'xh'</span><span class="token punctuation">,</span> <span class="token string">'16'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
xm <span class="token operator">==</span> xh<span class="token punctuation">;</span> <span class="token comment">//false</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>
<p>构造方式:</p>
<ul>
<li>
<p>构造函数使用<code v-pre>new</code>运算符，生成实例，并且<code v-pre>this</code>变量会绑定在实例对象上。</p>
</li>
<li>
<p>优点：解决了重复实例化的问题 ，又解决了对象识别的问题</p>
</li>
<li>
<p>缺点：每个方法都要在每个实例上重新创建一遍。</p>
</li>
</ul>
</li>
</ul>
...
<span class="token keyword">var</span> xm <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Person</span><span class="token punctuation">(</span><span class="token string">'xm'</span><span class="token punctuation">,</span> <span class="token string">'23'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">var</span> xh <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Person</span><span class="token punctuation">(</span><span class="token string">'xh'</span><span class="token punctuation">,</span> <span class="token string">'16'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>构造方式与工厂模式的区别:</strong></p>
<ol>
<li>
<p>构造方式不会显示创建对象，只要将属性和方法赋值给<code v-pre>this</code>，不需要<code v-pre>return</code>语句</p>
</li>
<li>
<p>工厂在方法内部创建<code v-pre>object</code>对象，最后返回<code v-pre>object</code>对象，属性和方法都是赋值 <code v-pre>object</code>对象</p>
</li>
</ol>
<ul>
<li>
...
<ul>
<li>
<p>函数本身声明为空内容，利用<code v-pre>prototype</code>定义一些属性及方法。</p>
</li>
<li>
<p>优点：所有的实例共享<code v-pre>prototype</code>中的定义，节省了内存。</p>
</li>
<li>
<p>缺点：不能通过传递参数来初始化属性的值。由于原型的属性被所有实例共享，实例在修改原型中的引用类型时，其它实例也会发生改变。</p>
</li>
</ul>
</li>
</ul>
...
<span class="token class-name">Person</span><span class="token punctuation">.</span>prototype<span class="token punctuation">.</span>name <span class="token operator">=</span> <span class="token string">'xm'</span><span class="token punctuation">;</span>
<span class="token class-name">Person</span><span class="token punctuation">.</span>prototype<span class="token punctuation">.</span>age <span class="token operator">=</span> <span class="token string">'23'</span><span class="token punctuation">;</span>
<span class="token class-name">Person</span><span class="token punctuation">.</span>prototype<span class="token punctuation">.</span><span class="token function-variable function">sayName</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token function">alert</span><span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span>name<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>

<span class="token keyword">var</span> xm <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Person</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
xm<span class="token punctuation">.</span><span class="token function">sayName</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>原型模式的第二种方式 : json 数据定义</strong></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// jSON数据定义</span>
...
<span class="token class-name">Person</span><span class="token punctuation">.</span>prototype <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">name</span><span class="token operator">:</span> <span class="token string">'xm'</span><span class="token punctuation">,</span>
...
<p>这种概念非常简单，即用构造函数定义<strong>实例属性</strong>，用原型方式定义<strong>方法和共享的属性</strong>。</p>
<p>结果是，每个实例都会有自己的<strong>实例属性副本</strong>，但同时又<strong>共享着对方法的引用</strong>，节省内存。</p>
<p>此外，组合模式还支持向构造函数传递参数，可谓是集两家之所长。</p>
<p>在所接触的 JS 库中，<code v-pre>jQuery</code>类型的封装就是使用组合模式来实例的！！！</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">//混合模式</span>
<span class="token keyword">function</span> <span class="token function">Person</span><span class="token punctuation">(</span><span class="token parameter">name<span class="token punctuation">,</span> age</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">this</span><span class="token punctuation">.</span>name <span class="token operator">=</span> name<span class="token punctuation">;</span>
  <span class="token keyword">this</span><span class="token punctuation">.</span>age <span class="token operator">=</span> age<span class="token punctuation">;</span>
  <span class="token keyword">this</span><span class="token punctuation">.</span>friends <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token string">'xjin'</span><span class="token punctuation">,</span> <span class="token string">'xlv'</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
<span class="token class-name">Person</span><span class="token punctuation">.</span>prototype <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token keyword">var</span> xm <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Person</span><span class="token punctuation">(</span><span class="token string">'xm'</span><span class="token punctuation">,</span> <span class="token string">'23'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">var</span> xh <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Person</span><span class="token punctuation">(</span><span class="token string">'xh'</span><span class="token punctuation">,</span> <span class="token string">'16'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
xm<span class="token punctuation">.</span>friends<span class="token punctuation">.</span><span class="token function">push</span><span class="token punctuation">(</span><span class="token string">'xheihei'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>xm<span class="token punctuation">.</span>friends<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">//["xjin", "xlv", "xheihei"]</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>xh<span class="token punctuation">.</span>friends<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">//["xjin", "xlv"]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="工厂模式" tabindex="-1"><a class="header-anchor" href="#工厂模式" aria-hidden="true">#</a> 工厂模式</h4>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">let</span> Vue <span class="token comment">// bind on install</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="适配器模式" tabindex="-1"><a class="header-anchor" href="#适配器模式" aria-hidden="true">#</a> 适配器模式</h4>
<p>适配器用来解决两个接口不兼容的情况，不需要改变已有的接口，通过包装一层的方式实现两个接口的正常协作。</p>
<p>以下是如何实现适配器模式的例子</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Plug</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 Vue 中，我们其实经常使用到适配器模式。比如父组件传递给子组件一个时间戳属性，组件内部需要将时间戳转为正常的日期显示，一般会使用 <code v-pre>computed</code> 来做转换这件事情，这个过程就使用到了适配器模式。</p>
<h4 id="装饰模式" tabindex="-1"><a class="header-anchor" href="#装饰模式" aria-hidden="true">#</a> 装饰模式</h4>
<p>装饰模式不需要改变已有的接口，作用是给对象添加功能。就像我们经常需要给手机戴个保护套防摔一样，不改变手机自身，给手机添加了保护套提供防摔功能。</p>
<p>以下是如何实现装饰模式的例子，使用了 ES7 中的装饰器语法</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">readonly</span><span class="token punctuation">(</span><span class="token parameter">target<span class="token punctuation">,</span> key<span class="token punctuation">,</span> descriptor</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="代理模式" tabindex="-1"><a class="header-anchor" href="#代理模式" aria-hidden="true">#</a> 代理模式</h4>
...
<span class="token operator">&lt;</span>script<span class="token operator">></span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token operator">&lt;</span><span class="token operator">/</span>script<span class="token operator">></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>因为存在太多的 <code v-pre>li</code>，不可能每个都去绑定事件。这时候可以通过给父节点绑定一个事件，让父节点作为代理去拿到真实点击的节点</p>
<h4 id="发布-订阅模式" tabindex="-1"><a class="header-anchor" href="#发布-订阅模式" aria-hidden="true">#</a> 发布-订阅模式</h4>
...
<h4 id="外观模式" tabindex="-1"><a class="header-anchor" href="#外观模式" aria-hidden="true">#</a> 外观模式</h4>
<p>外观模式提供了一个接口，隐藏了内部的逻辑，更加方便外部调用。</p>
<p>举个例子来说，我们现在需要实现一个兼容多种浏览器的添加事件方法</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">addEvent</span><span class="token punctuation">(</span><span class="token parameter">elm<span class="token punctuation">,</span> evType<span class="token punctuation">,</span> fn<span class="token punctuation">,</span> useCapture</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<div class="custom-container tip">
<p class="custom-container-title">思路</p>
<p>首先要记起来getInstance方法和instance这个变量是干啥的。最好能把闭包的版本也写出来！</p>
</div>
<ul>
<li>实现：静态方法版</li>
</ul>
...
<div class="custom-container tip">
<p class="custom-container-title">思路</p>
<p>记住getInstance方法、记住instance变量、记住闭包和静态方法</p>
</div>
<ul>
<li>ES6版本</li>
</ul>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
    ...
    <span class="token keyword">class</span> <span class="token class-name">Modal</span><span class="token punctuation">{</span>
      <span class="token function">constructor</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
        ...
        <span class="token keyword">if</span><span class="token punctuation">(</span><span class="token operator">!</span>Modal<span class="token punctuation">.</span>instance<span class="token punctuation">)</span><span class="token punctuation">{</span>
          ...
          <span class="token keyword">this</span><span class="token punctuation">.</span>dom<span class="token punctuation">.</span>innerHTML <span class="token operator">=</span> <span class="token string">'我是一个全局唯一的Modal'</span>
          <span class="token keyword">this</span><span class="token punctuation">.</span>dom<span class="token punctuation">.</span>id <span class="token operator">=</span> <span class="token string">'modal'</span>
          ...
          <span class="token keyword">this</span><span class="token punctuation">.</span>dom<span class="token punctuation">.</span>showModal <span class="token operator">=</span> <span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">show</span><span class="token punctuation">.</span><span class="token function">bind</span><span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">)</span>
          ...
          Modal<span class="token punctuation">.</span>instance <span class="token operator">=</span> <span class="token keyword">this</span><span class="token punctuation">.</span>dom
        <span class="token punctuation">}</span>
        <span class="token keyword">return</span> Modal<span class="token punctuation">.</span>instance
      <span class="token punctuation">}</span>
      <span class="token function">show</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
        <span class="token keyword">this</span><span class="token punctuation">.</span>dom<span class="token punctuation">.</span>style<span class="token punctuation">.</span>display <span class="token operator">=</span> <span class="token string">'block'</span>
      <span class="token punctuation">}</span>
    ...
    document<span class="token punctuation">.</span><span class="token function">getElementById</span><span class="token punctuation">(</span><span class="token string">'open'</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">'click'</span><span class="token punctuation">,</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    	...
    	modal<span class="token punctuation">.</span><span class="token function">showModal</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
    <span class="token punctuation">}</span><span class="token punctuation">)</span>
    ...
    document<span class="token punctuation">.</span><span class="token function">getElementById</span><span class="token punctuation">(</span><span class="token string">'close'</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">'click'</span><span class="token punctuation">,</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
      <span class="token keyword">const</span> modal <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Modal</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
        ...
        modal<span class="token punctuation">.</span><span class="token function">hideModal</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
    	<span class="token punctuation">}</span>
    <span class="token punctuation">}</span><span class="token punctuation">)</span>
</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>script</span><span class="token punctuation">></span></span>
...
<li>CommonJS 在导出时都是<strong>值拷贝</strong>，就算导出的值变了，导入的值也不会改变，所以如果想更新值，必须重新导入一次。但是 ES Module 采用实时绑定的方式，导入导出的值都指向同一个内存地址，所以导入值会跟随导出值变化</li>
...
<ol>
<li>
<p><code v-pre>event.preventDefault()</code>：阻止默认事件；</p>
</li>
<li>
<p><code v-pre>event.stopPropagation()</code>：阻止冒泡事件；(其实也可以阻止捕获)</p>
</li>
<li>
<p><code v-pre>event.stoplmmediatePropagation()</code>：事件响应优先级 阻止相同事件类型监听函数执行。如先后定义 A,B 两个点击事件， a 使用此方法后 b 事件将不再执行。</p>
</li>
<li>
<p><code v-pre>event.currentTarget</code>：当前绑定事件的元素；</p>
</li>
<li>
<p><code v-pre>event.target</code>：当前被点击的元素；</p>
</li>
</ol>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="highlight-lines"><br><div class="highlight-line">&nbsp;</div><div class="highlight-line">&nbsp;</div><div class="highlight-line">&nbsp;</div><br><br><div class="highlight-line">&nbsp;</div><br><br><br><br><div class="highlight-line">&nbsp;</div><br></div><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="怎么注册事件" tabindex="-1"><a class="header-anchor" href="#怎么注册事件" aria-hidden="true">#</a> 怎么注册事件？</h4>
...
<li>
<p>网络请求: <code v-pre>ajax</code> , <code v-pre>img</code>加载, 脚本等文件加载和下载</p>
</li>
<li>
<p>事件绑定</p>
</li>
...
<ul>
<li>JS 是单线程语言， 只能同时做一件事。JS任务包含了同步任务和异步任务。</li>
<li>同步和异步任务分别进入不同的执行&quot;场所&quot;，同步的进入主线程，异步的进入 Event Table 并注册函数。</li>
<li>当指定的事情完成时，Event Table 会将这个函数移入 Event Queue</li>
<li>主线程内的任务执行完毕为空，会去 Event Queue 读取对应的函数，进入主线程执行。(执行完所有微任务后，如有必要会渲染页面)</li>
...
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1584321815238.png" alt="执行栈"></p>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1584321844463.png" alt="执行步骤"></p>
<p>Event Loop 执行顺序如下所示：</p>
<ul>
<li>首先 JavaScript 引擎会执行一个宏任务，注意这个宏任务一般是指主干代码本身，也就是目前的同步代码</li>
<li>执行过程中如果遇到微任务，就把它添加到微任务任务队列中</li>
<li>宏任务执行完成后，立即执行当前微任务队列中的微任务，直到微任务队列被清空</li>
<li>微任务执行完成后，开始执行下一个宏任务</li>
<li>如此循环往复，直到宏任务和微任务被清空</li>
</ul>
<p>宏任务（macro-task）: 同步 script (整体代码)，<code v-pre>setTimeout</code> 回调函数, <code v-pre>setInterval</code> 回调函数, <code v-pre>I/O</code>, <code v-pre>UI rendering</code>；</p>
<p>微任务（micro-task）: <code v-pre>process.nextTick</code>, <code v-pre>Promise</code> 回调函数，<code v-pre>Object.observe</code>，<code v-pre>MutationObserver</code></p>
...
<li>
<p>缺点: 无法取消 promise, 错误需要回调函数捕获</p>
</li>
</ul>
...
<p>异步编程当然少不了定时器了，常见的定时器函数有 <code v-pre>setTimeout</code>、<code v-pre>setInterval</code>、<code v-pre>requestAnimationFram</code>e。我们先来讲讲最常用的<code v-pre>setTimeout</code>，很多人认为 <code v-pre>setTimeout</code> 是延时多久，那就应该是多久后执行。</p>
...
<p>通常来说不建议使用 setInterval。
第一，它和 <code v-pre>setTimeout</code> 一样，不能保证在预期的时间执行任务。
第二，它存在执行累积的问题.</p>
...
<ul>
<li>
<p>在<strong>语法</strong>上更贴合面向对象的写法</p>
</li>
<li>
<p>在<strong>继承</strong>上更容易阅读理解</p>
</li>
</ul>
...
<h4 id="proxy-可以实现什么功能" tabindex="-1"><a class="header-anchor" href="#proxy-可以实现什么功能" aria-hidden="true">#</a> Proxy 可以实现什么功能？</h4>
<p>在 Vue3.0 中将会通过 Proxy 来替换原本的 <code v-pre>Object.defineProperty</code> 来实现数据响应式。 <code v-pre>Proxy</code> 是 ES6 中新增的功能，它可以用来自定义对象中的操作。</p>
<p>之所以 Vue3.0 要使用 <code v-pre>Proxy</code> 替换原本的 API 原因在于 <code v-pre>Proxy</code> 无需一层层递归为每个属性添加代理，一次即可完成以上操作，性能上更好，并且原本的实现有一些数据更新不能监听到，但是 <code v-pre>Proxy</code> 可以完美监听到任何方式的数据改变，唯一缺陷可能就是浏览器的兼容性不好了。</p>
...
<p>箭头函数比普通函数更加简洁，没有<code v-pre>this</code>，不存在<code v-pre>arguments</code>对象，没有原型属性，不能当作构造函数，不能用作<code v-pre>Generator</code>函数 (不能使用<code v-pre>yield</code>命令)</p>
...
<p>先说原因，因为 JS 采用 <strong>IEEE 754 双精度版本（64位）</strong>，并且只要采用 IEEE 754 的语言都有该问题。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="笔试题-1" tabindex="-1"><a class="header-anchor" href="#笔试题-1" aria-hidden="true">#</a> 笔试题</h2>
<h4 id="创建-10-个-a-标签-点击的时候弹出对应的序号" tabindex="-1"><a class="header-anchor" href="#创建-10-个-a-标签-点击的时候弹出对应的序号" aria-hidden="true">#</a> 创建 10 个<code v-pre>&lt;a&gt;</code>标签， 点击的时候弹出对应的序号</h4>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> frag <span class="token operator">=</span> document<span class="token punctuation">.</span><span class="token function">createDocumentFragment</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">const</span> Max <span class="token operator">=</span> <span class="token number">10</span><span class="token punctuation">;</span>
<span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">let</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> Max<span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  a<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">'click'</span><span class="token punctuation">,</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">e</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token function">alert</span><span class="token punctuation">(</span>e<span class="token punctuation">.</span>target<span class="token punctuation">.</span>innerText<span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  frag<span class="token punctuation">.</span><span class="token function">appendChild</span><span class="token punctuation">(</span>a<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="用-js-实现一个-99-乘法表" tabindex="-1"><a class="header-anchor" href="#用-js-实现一个-99-乘法表" aria-hidden="true">#</a> 用 js 实现一个 99 乘法表</h4>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">let</span> i <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span> i <span class="token operator">&lt;=</span> <span class="token number">9</span><span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">let</span> j <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span> j <span class="token operator">&lt;=</span> i<span class="token punctuation">;</span> j<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">var</span> result <span class="token operator">=</span> i <span class="token operator">*</span> j<span class="token punctuation">;</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="自己实现一个实现一个new操作符" tabindex="-1"><a class="header-anchor" href="#自己实现一个实现一个new操作符" aria-hidden="true">#</a> 自己实现一个实现一个<code v-pre>new</code>操作符:</h4>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">create</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">let</span> obj <span class="token operator">=</span> <span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">;</span> <span class="token comment">//创建一个空对象</span>
  <span class="token keyword">let</span> Con <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">.</span><span class="token function">shift</span><span class="token punctuation">.</span><span class="token function">call</span><span class="token punctuation">(</span>arguments<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">//获取第一个传进来的参数，也就是构造函数</span>
  obj<span class="token punctuation">.</span>__proto__ <span class="token operator">=</span> <span class="token class-name">Con</span><span class="token punctuation">.</span>prototype<span class="token punctuation">;</span> <span class="token comment">//链接到构造函数原型</span>
  <span class="token keyword">let</span> result <span class="token operator">=</span> <span class="token function">Con</span><span class="token punctuation">.</span><span class="token function">apply</span><span class="token punctuation">(</span>obj<span class="token punctuation">,</span> arguments<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">//绑定 this 并执行构造函数</span>
  <span class="token keyword">return</span> result <span class="token keyword">instanceof</span> <span class="token class-name">Object</span> <span class="token operator">?</span> result <span class="token operator">:</span> obj<span class="token punctuation">;</span> <span class="token comment">//确保返回值为对象</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="手写深拷贝" tabindex="-1"><a class="header-anchor" href="#手写深拷贝" aria-hidden="true">#</a> 手写深拷贝</h4>
...
<span class="token keyword">var</span> obj <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token literal-property property">info</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">money</span><span class="token operator">:</span> <span class="token punctuation">[</span><span class="token number">5</span><span class="token punctuation">]</span><span class="token punctuation">,</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
...
cloneObj<span class="token punctuation">.</span>name <span class="token operator">=</span> <span class="token string">'小黑'</span><span class="token punctuation">;</span>
cloneObj<span class="token punctuation">.</span>info<span class="token punctuation">.</span>money <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token number">88</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
console<span class="token punctuation">.</span><span class="token function">info</span><span class="token punctuation">(</span>obj<span class="token punctuation">,</span> cloneObj<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="写一个-clone-函数-可以复制原始类型的值" tabindex="-1"><a class="header-anchor" href="#写一个-clone-函数-可以复制原始类型的值" aria-hidden="true">#</a> 写一个 clone 函数,可以复制原始类型的值.</h4>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">clone</span><span class="token punctuation">(</span><span class="token parameter">obj</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">switch</span> <span class="token punctuation">(</span><span class="token keyword">typeof</span> obj<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">case</span> <span class="token string">'string'</span><span class="token operator">:</span>
      o <span class="token operator">=</span> obj <span class="token operator">+</span> <span class="token string">''</span><span class="token punctuation">;</span>
      <span class="token keyword">break</span><span class="token punctuation">;</span>
    <span class="token keyword">case</span> <span class="token string">'number'</span><span class="token operator">:</span>
      o <span class="token operator">=</span> obj <span class="token operator">-</span> <span class="token number">0</span><span class="token punctuation">;</span>
      <span class="token keyword">break</span><span class="token punctuation">;</span>
    <span class="token keyword">case</span> <span class="token string">'boolean'</span><span class="token operator">:</span>
      o <span class="token operator">=</span> obj<span class="token punctuation">;</span>
      <span class="token keyword">break</span><span class="token punctuation">;</span>
    <span class="token keyword">case</span> <span class="token string">'object'</span><span class="token operator">:</span>
      ...
      <span class="token punctuation">}</span> <span class="token keyword">else</span> <span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token class-name">Object</span><span class="token punctuation">.</span>prototype<span class="token punctuation">.</span><span class="token function">toString</span><span class="token punctuation">.</span><span class="token function">call</span><span class="token punctuation">(</span>obj<span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">slice</span><span class="token punctuation">(</span><span class="token number">8</span><span class="token punctuation">,</span> <span class="token operator">-</span><span class="token number">1</span><span class="token punctuation">)</span> <span class="token operator">===</span> <span class="token string">'Array'</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">var</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> obj<span class="token punctuation">.</span>length<span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
          o<span class="token punctuation">.</span><span class="token function">push</span><span class="token punctuation">(</span><span class="token function">clone</span><span class="token punctuation">(</span>obj<span class="token punctuation">[</span>i<span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">//深拷贝</span>
        <span class="token punctuation">}</span>
      <span class="token punctuation">}</span> <span class="token keyword">else</span> <span class="token punctuation">{</span>
        o <span class="token operator">=</span> <span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">;</span>
...
<span class="token keyword">var</span> a <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token number">12.3</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token function">clone</span><span class="token punctuation">(</span>a<span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="以下代码如何实现点击列表显示相应的-index-值" tabindex="-1"><a class="header-anchor" href="#以下代码如何实现点击列表显示相应的-index-值" aria-hidden="true">#</a> 以下代码如何实现点击列表显示相应的 index 值?</h4>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>ul id<span class="token operator">=</span><span class="token string">"test"</span><span class="token operator">></span>
    <span class="token operator">&lt;</span>li<span class="token operator">></span><span class="token number">1</span><span class="token operator">&lt;</span><span class="token operator">/</span>li<span class="token operator">></span>
    <span class="token operator">&lt;</span>li<span class="token operator">></span><span class="token number">2</span><span class="token operator">&lt;</span><span class="token operator">/</span>li<span class="token operator">></span>
    <span class="token operator">&lt;</span>li<span class="token operator">></span><span class="token number">3</span><span class="token operator">&lt;</span><span class="token operator">/</span>li<span class="token operator">></span>
<span class="token operator">&lt;</span><span class="token operator">/</span>ul<span class="token operator">></span>　　
...
<span class="token keyword">var</span> ul <span class="token operator">=</span> document<span class="token punctuation">.</span><span class="token function">getElementById</span><span class="token punctuation">(</span><span class="token string">'test'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">var</span> lis <span class="token operator">=</span> Array<span class="token punctuation">.</span><span class="token function">from</span><span class="token punctuation">(</span>ul<span class="token punctuation">.</span><span class="token function">getElementsByTagName</span><span class="token punctuation">(</span><span class="token string">"li"</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
ul<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">"click"</span><span class="token punctuation">,</span><span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">e</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>lis<span class="token punctuation">.</span><span class="token function">indexOf</span><span class="token punctuation">(</span>e<span class="token punctuation">.</span>target<span class="token punctuation">)</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>


<span class="token comment">//使用jq:</span>
<span class="token operator">&lt;</span>script src<span class="token operator">=</span><span class="token string">"https://cdn.bootcss.com/jquery/3.4.0/jquery.min.js"</span><span class="token operator">></span><span class="token operator">&lt;</span><span class="token operator">/</span>script<span class="token operator">></span>
<span class="token operator">&lt;</span>script<span class="token operator">></span>
<span class="token function">$</span><span class="token punctuation">(</span><span class="token string">'#test'</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">on</span><span class="token punctuation">(</span><span class="token string">'click'</span><span class="token punctuation">,</span><span class="token string">'li'</span><span class="token punctuation">,</span><span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">e</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
        <span class="token function">alert</span><span class="token punctuation">(</span><span class="token function">$</span><span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">index</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="手写-call-函数" tabindex="-1"><a class="header-anchor" href="#手写-call-函数" aria-hidden="true">#</a> 手写 call 函数</h4>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token class-name">Function</span><span class="token punctuation">.</span>prototype<span class="token punctuation">.</span><span class="token function-variable function">myCall</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">context</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token keyword">typeof</span> <span class="token keyword">this</span> <span class="token operator">!==</span> <span class="token string">'function'</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">throw</span> <span class="token keyword">new</span> <span class="token class-name">TypeError</span><span class="token punctuation">(</span><span class="token string">'Error'</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//调用`myCall`的对象必须是函数，如果是非函数会报错</span>
  <span class="token punctuation">}</span>
  context <span class="token operator">=</span> context <span class="token operator">||</span> window<span class="token punctuation">;</span> <span class="token comment">//如果不传参，默认为window  此时context为o</span>
  context<span class="token punctuation">.</span>fn <span class="token operator">=</span> <span class="token keyword">this</span><span class="token punctuation">;</span> <span class="token comment">//在o对象增加fn方法，指向需要调用的函数。此时调用myCall的就是a函数，this为a，也就是说调用的方法a变成了绑定对象下的方法a</span>
  <span class="token keyword">const</span> args <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token operator">...</span>arguments<span class="token punctuation">]</span><span class="token punctuation">.</span><span class="token function">slice</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">//从第一个参数后面进行复制</span>
  <span class="token keyword">const</span> result <span class="token operator">=</span> context<span class="token punctuation">.</span><span class="token function">fn</span><span class="token punctuation">(</span><span class="token operator">...</span>args<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">//截取后的name，age作为参数传入了a函数，执行a函数</span>
  <span class="token keyword">delete</span> context<span class="token punctuation">.</span>fn<span class="token punctuation">;</span> <span class="token comment">//删除o对象的fn属性</span>
  <span class="token keyword">return</span> result<span class="token punctuation">;</span> <span class="token comment">//返回调用函数</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>

<span class="token keyword">function</span> <span class="token function">a</span><span class="token punctuation">(</span><span class="token parameter">name<span class="token punctuation">,</span> age<span class="token punctuation">,</span> sex</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  console<span class="token punctuation">.</span><span class="token function">info</span><span class="token punctuation">(</span>name<span class="token punctuation">,</span> age<span class="token punctuation">,</span> sex<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
<span class="token keyword">var</span> name <span class="token operator">=</span> <span class="token string">'xh'</span><span class="token punctuation">,</span>
...
<span class="token keyword">let</span> o <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">name</span><span class="token operator">:</span> <span class="token string">'xz'</span><span class="token punctuation">,</span>
  <span class="token literal-property property">age</span><span class="token operator">:</span> <span class="token string">'13'</span><span class="token punctuation">,</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token function">a</span><span class="token punctuation">(</span>name<span class="token punctuation">,</span> age<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">//xh 23            /xh 23 undefined  这个this是指向window</span>
a<span class="token punctuation">.</span><span class="token function">myCall</span><span class="token punctuation">(</span>o<span class="token punctuation">,</span> name<span class="token punctuation">,</span> age<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">//xz 13    /xh 23 undefined   这个this执行o</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="手写-apply-函数" tabindex="-1"><a class="header-anchor" href="#手写-apply-函数" aria-hidden="true">#</a> 手写 apply 函数</h4>
<p>和<code v-pre>call</code>类似，区别在于处理参数，判断是否有第二个参数，如果有将作为数组传入调用函数</p>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token class-name">Function</span><span class="token punctuation">.</span>prototype<span class="token punctuation">.</span><span class="token function-variable function">myBind</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">context</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="给定一段-url-和参数的名称-获取此参数的值" tabindex="-1"><a class="header-anchor" href="#给定一段-url-和参数的名称-获取此参数的值" aria-hidden="true">#</a> 给定一段 URL 和参数的名称，获取此参数的值</h4>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">getQuery</span><span class="token punctuation">(</span><span class="token parameter">url<span class="token punctuation">,</span>name</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
  <span class="token keyword">let</span> strs
  ...
  <span class="token punctuation">}</span>
  <span class="token keyword">for</span><span class="token punctuation">(</span><span class="token keyword">let</span> k <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> k <span class="token operator">&lt;</span> strs<span class="token punctuation">.</span>length<span class="token punctuation">;</span>k<span class="token operator">++</span> <span class="token punctuation">)</span><span class="token punctuation">{</span>
    splitItem  <span class="token operator">=</span> strs<span class="token punctuation">[</span>k<span class="token punctuation">]</span><span class="token punctuation">.</span><span class="token function">split</span><span class="token punctuation">(</span><span class="token string">'='</span><span class="token punctuation">)</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
<span class="token keyword">const</span> url <span class="token operator">=</span> <span class="token string">'https://www.baidu.com/s?id=123&amp;name=why&amp;phone=13876769797'</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token function">getQuery</span><span class="token punctuation">(</span>url<span class="token punctuation">,</span><span class="token string">'name'</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token comment">//why</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="写一个方法-去除掉重复元素" tabindex="-1"><a class="header-anchor" href="#写一个方法-去除掉重复元素" aria-hidden="true">#</a> 写一个方法 , 去除掉重复元素...</h4>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token punctuation">{</span><span class="token comment">//第一种</span>
  <span class="token keyword">let</span> arr <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">]</span>
  <span class="token keyword">let</span> nArr <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token punctuation">]</span>
  <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">let</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> arr<span class="token punctuation">.</span>length<span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">if</span> <span class="token punctuation">(</span>nArr<span class="token punctuation">.</span><span class="token function">indexOf</span><span class="token punctuation">(</span>arr<span class="token punctuation">[</span>i<span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token operator">===</span><span class="token operator">-</span><span class="token number">1</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
      nArr<span class="token punctuation">.</span><span class="token function">push</span><span class="token punctuation">(</span>arr<span class="token punctuation">[</span>i<span class="token punctuation">]</span><span class="token punctuation">)</span>
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span>
  console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>nArr<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token punctuation">{</span><span class="token comment">//第二种</span>
  <span class="token keyword">let</span> arr <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">]</span>
  <span class="token keyword">let</span> nArr <span class="token operator">=</span> arr<span class="token punctuation">.</span><span class="token function">filter</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">current<span class="token punctuation">,</span> index<span class="token punctuation">,</span> self</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
    <span class="token keyword">return</span> self<span class="token punctuation">.</span><span class="token function">indexOf</span><span class="token punctuation">(</span>current<span class="token punctuation">)</span> <span class="token operator">===</span> index
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
  console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>nArr<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token punctuation">{</span><span class="token comment">//第三种</span>
  <span class="token keyword">let</span> arr <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">]</span>
  ...
  <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">let</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> arr<span class="token punctuation">.</span>length<span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token operator">!</span>obj<span class="token punctuation">[</span>arr<span class="token punctuation">[</span>i<span class="token punctuation">]</span><span class="token punctuation">]</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
      nArr<span class="token punctuation">.</span><span class="token function">push</span><span class="token punctuation">(</span>arr<span class="token punctuation">[</span>i<span class="token punctuation">]</span><span class="token punctuation">)</span>
      obj<span class="token punctuation">[</span>arr<span class="token punctuation">[</span>i<span class="token punctuation">]</span><span class="token punctuation">]</span> <span class="token operator">=</span> <span class="token boolean">true</span>
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span>
  console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>nArr<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token comment">// 利用 集合 来简化实现 ( ES6 Set )</span>
<span class="token punctuation">{</span>
  <span class="token keyword">let</span> _set <span class="token operator">=</span> <span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">;</span>
  <span class="token keyword">let</span> _newarr <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
  arr<span class="token punctuation">.</span><span class="token function">forEach</span><span class="token punctuation">(</span> <span class="token parameter">v</span> <span class="token operator">=></span> _set<span class="token punctuation">[</span> v <span class="token punctuation">]</span> <span class="token operator">||</span> <span class="token punctuation">(</span> _set<span class="token punctuation">[</span> v <span class="token punctuation">]</span> <span class="token operator">=</span> <span class="token boolean">true</span><span class="token punctuation">,</span> _newarr<span class="token punctuation">.</span><span class="token function">push</span><span class="token punctuation">(</span> v <span class="token punctuation">)</span> <span class="token punctuation">)</span> <span class="token punctuation">)</span> <span class="token comment">// 减少赋值行为</span>
<span class="token punctuation">}</span>

<span class="token punctuation">{</span><span class="token comment">//第四种</span>
  <span class="token keyword">let</span> arr <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">]</span>
  <span class="token keyword">let</span> nArr <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Set</span><span class="token punctuation">(</span>arr<span class="token punctuation">)</span>
  console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>Array<span class="token punctuation">.</span><span class="token function">from</span><span class="token punctuation">(</span>nArr<span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="如何判断一个对象是否为数组" tabindex="-1"><a class="header-anchor" href="#如何判断一个对象是否为数组" aria-hidden="true">#</a> 如何判断一个对象是否为数组</h4>
<ul>
<li>使用 <code v-pre>Array.isArray</code> 判断，如果返回 true, 说明是数组</li>
<li>使用 <code v-pre>instanceof Array</code> 判断，如果返回 true, 说明是数组</li>
</ul>
<h5 id="自己实现一个-isarray" tabindex="-1"><a class="header-anchor" href="#自己实现一个-isarray" aria-hidden="true">#</a> 自己实现一个 isArray</h5>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>理解： <code v-pre>Object</code>对象和它的原型链上各自有一个<code v-pre>toString()</code>方法，第一个返回的是一个函数，第二个返回的是值类型。</p>
<p>通过<code v-pre>call</code>将<code v-pre>Array</code>的<code v-pre>this</code>上下文切换到<code v-pre>Object</code>，从而调用了<code v-pre>Object.prototype.toString()</code>，因此返回<code v-pre>[object Array]</code>。</p>
<h5 id="为什么不直接-array-prototype-tostring-call-arg" tabindex="-1"><a class="header-anchor" href="#为什么不直接-array-prototype-tostring-call-arg" aria-hidden="true">#</a> 为什么不直接 <code v-pre>Array.prototype.toString.call([arg])</code>?</h5>
<p>因为<code v-pre>Array</code>，<code v-pre>Function</code>,虽然是基于<code v-pre>Object</code> 进行创建的，但是他们继承的是<code v-pre>Object.toString()</code>，而不是<code v-pre>Object.prototype.toString()</code>。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="快速排序" tabindex="-1"><a class="header-anchor" href="#快速排序" aria-hidden="true">#</a> 快速排序</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="求一个字符出现的次数" tabindex="-1"><a class="header-anchor" href="#求一个字符出现的次数" aria-hidden="true">#</a> 求一个字符出现的次数</h4>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">queryStr</span><span class="token punctuation">(</span><span class="token parameter">str</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token comment">//循环字符串，获取每个字符</span>
  <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">let</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> str<span class="token punctuation">.</span>length<span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token operator">!</span>json<span class="token punctuation">[</span>str<span class="token punctuation">.</span><span class="token function">charAt</span><span class="token punctuation">(</span>i<span class="token punctuation">)</span><span class="token punctuation">]</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
      <span class="token comment">//判断json对象内是否有当前字符串内字符，如果没有将此字符作为键,值为1</span>
    ...
    <span class="token punctuation">}</span> <span class="token keyword">else</span> <span class="token punctuation">{</span>
      <span class="token comment">//如果json已经有当前字符传内字符，将值+1</span>
  ...
  <span class="token comment">//循环json对象</span>
  <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">let</span> i <span class="token keyword">in</span> json<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">if</span> <span class="token punctuation">(</span>json<span class="token punctuation">[</span>i<span class="token punctuation">]</span> <span class="token operator">></span> max<span class="token punctuation">)</span> <span class="token punctuation">{</span>
      <span class="token comment">//如果json对象内有值大于max，max就设置为此对象值，msg设置为此键</span>
      max <span class="token operator">=</span> json<span class="token punctuation">[</span>i<span class="token punctuation">]</span><span class="token punctuation">;</span>
      msg <span class="token operator">=</span> i<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span>
  <span class="token keyword">return</span> <span class="token punctuation">{</span>
...
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token string">'出现次数最多的字符是：'</span><span class="token punctuation">,</span><span class="token function">queryStr</span><span class="token punctuation">(</span><span class="token string">'hello'</span><span class="token punctuation">)</span><span class="token punctuation">.</span>msg<span class="token punctuation">,</span><span class="token string">'出现次数为：'</span><span class="token punctuation">,</span><span class="token function">queryStr</span><span class="token punctuation">(</span><span class="token string">'hello'</span><span class="token punctuation">)</span><span class="token punctuation">.</span>max<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="编写一个方法-求一个字符串的字节长度" tabindex="-1"><a class="header-anchor" href="#编写一个方法-求一个字符串的字节长度" aria-hidden="true">#</a> 编写一个方法 求一个字符串的字节长度</h4>
<p>假设：一个英文字符占用一个字节，一个中文字符占用两个字节</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">GetBytes</span><span class="token punctuation">(</span><span class="token parameter">str</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="highlight-lines"><br><br><br><br><div class="highlight-line">&nbsp;</div><br><br><br><br></div><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="写一个遍历对象和数组的-foreach-函数" tabindex="-1"><a class="header-anchor" href="#写一个遍历对象和数组的-foreach-函数" aria-hidden="true">#</a> 写一个遍历对象和数组的 forEach 函数</h4>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">myForEach</span><span class="token punctuation">(</span><span class="token parameter">obj<span class="token punctuation">,</span> fn</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">if</span> <span class="token punctuation">(</span>Array<span class="token punctuation">.</span><span class="token function">isArray</span><span class="token punctuation">(</span>obj<span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token comment">//准确判断是不是数组</span>
    obj<span class="token punctuation">.</span><span class="token function">forEach</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">elem<span class="token punctuation">,</span> index</span><span class="token punctuation">)</span><span class="token operator">=></span><span class="token punctuation">{</span>
      <span class="token function">fn</span><span class="token punctuation">(</span>elem<span class="token punctuation">,</span> index<span class="token punctuation">)</span>
    <span class="token punctuation">}</span><span class="token punctuation">)</span>
  <span class="token punctuation">}</span> <span class="token keyword">else</span> <span class="token punctuation">{</span><span class="token comment">//不是数组就是对象</span>
    <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">let</span> k <span class="token keyword">in</span> obj<span class="token punctuation">)</span> <span class="token punctuation">{</span>
      <span class="token function">fn</span><span class="token punctuation">(</span>obj<span class="token punctuation">[</span>k<span class="token punctuation">]</span><span class="token punctuation">,</span> k<span class="token punctuation">)</span>
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>

<span class="token keyword">var</span> arr <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
<span class="token function">myForEach</span><span class="token punctuation">(</span>arr<span class="token punctuation">,</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">item<span class="token punctuation">,</span> index</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">Promise</span><span class="token punctuation">(</span><span class="token parameter">excutor</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
	...
	<span class="token keyword">this</span><span class="token punctuation">.</span>onFulfilledArray <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token punctuation">]</span>
	...
	<span class="token keyword">const</span> <span class="token function-variable function">resolve</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token parameter">value</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
		...
		<span class="token function">setTimeout</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
			<span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span>status <span class="token operator">===</span> <span class="token string">'pending'</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
				...
				<span class="token keyword">this</span><span class="token punctuation">.</span>onFulfilledArray<span class="token punctuation">.</span><span class="token function">forEach</span><span class="token punctuation">(</span><span class="token parameter">func</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
					<span class="token function">func</span><span class="token punctuation">(</span>value<span class="token punctuation">)</span>
				<span class="token punctuation">}</span><span class="token punctuation">)</span>
			<span class="token punctuation">}</span>
		<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
	<span class="token punctuation">}</span>
	...
	<span class="token keyword">const</span> <span class="token function-variable function">reject</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token parameter">reason</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
		<span class="token function">setTimeout</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
			<span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span>status <span class="token operator">===</span> <span class="token string">'pending'</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
				...
				<span class="token keyword">this</span><span class="token punctuation">.</span>onRejectedArray<span class="token punctuation">.</span><span class="token function">forEach</span><span class="token punctuation">(</span><span class="token parameter">func</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
					<span class="token function">func</span><span class="token punctuation">(</span>reason<span class="token punctuation">)</span>
				<span class="token punctuation">}</span><span class="token punctuation">)</span>
			<span class="token punctuation">}</span>
		<span class="token punctuation">}</span><span class="token punctuation">)</span>
	<span class="token punctuation">}</span>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">jQuery</span> <span class="token punctuation">{</span>
  ...
  <span class="token function">each</span><span class="token punctuation">(</span><span class="token parameter">fn</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span>
  <span class="token comment">//扩展更多 DOM API</span>
<span class="token punctuation">}</span>
...
<span class="token keyword">const</span> $p <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">myJquery</span><span class="token punctuation">(</span><span class="token string">'p'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>$p<span class="token punctuation">)</span><span class="token punctuation">;</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>$p<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
$p<span class="token punctuation">.</span><span class="token function">each</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">elem</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
  console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>elem<span class="token punctuation">.</span>innerText<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="编写一个通用的事件监听函数" tabindex="-1"><a class="header-anchor" href="#编写一个通用的事件监听函数" aria-hidden="true">#</a> 编写一个通用的事件监听函数</h4>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">on</span><span class="token punctuation">(</span><span class="token parameter">elem<span class="token punctuation">,</span> type<span class="token punctuation">,</span> selector<span class="token punctuation">,</span> fn</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="手写一个简易的-ajax" tabindex="-1"><a class="header-anchor" href="#手写一个简易的-ajax" aria-hidden="true">#</a> 手写一个简易的 ajax</h4>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">ajax</span><span class="token punctuation">(</span><span class="token parameter">url</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token keyword">const</span> url <span class="token operator">=</span> <span class="token string">'/data/test.json'</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="用es5写一个能够生成迭代器对象的迭代器生成函数" tabindex="-1"><a class="header-anchor" href="#用es5写一个能够生成迭代器对象的迭代器生成函数" aria-hidden="true">#</a> 用ES5写一个能够生成迭代器对象的迭代器生成函数</h4>
...
<h4 id="git和svn的区别" tabindex="-1"><a class="header-anchor" href="#git和svn的区别" aria-hidden="true">#</a> git和svn的区别?</h4>
<ul>
<li>中央版本控制系统</li>
</ul>
<p><code v-pre>SVN</code> 是中央版本控制系统，必须存在两个端，服务端和客户端。</p>
<p>客户端都是把数据推送服务器当中去，拉取的时候代码也都是从服务器中获取，是非常典型的 C/S 机制；所有客户端的交互都必须通过中央服务器，不能私下直接访问。</p>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1588082088250.png" alt="SVN"></p>
<ul>
<li>分布式版本控制系统</li>
</ul>
<p><code v-pre>Git</code> 是分布式版本控制系统。是将备份的代码以及记录完全独立在本地存储。当你想将代码恢复到某一个版本的时候，本地版本控制器，不需要依赖网络便可以完成此操作。</p>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1589192077169.png" alt="git"></p>
<p><strong>区别：</strong></p>
<ul>
<li><code v-pre>Git</code>可以在客户端自由创建分支，<code v-pre>SVN</code> 必须由服务器创建。</li>
<li><code v-pre>Git</code>没有网络依然可以提交代码， <code v-pre>SVN</code> 必须连接服务器才可以提交。</li>
</ul>
<h2 id="webpack" tabindex="-1"><a class="header-anchor" href="#webpack" aria-hidden="true">#</a> Webpack</h2>
<p>关于 webpack 面试题可参考 <a href="http://l544402029.gitee.io/blog/%E5%89%8D%E7%AB%AF%E5%B7%A5%E5%85%B7/webpack/#%E5%B8%B8%E8%A7%81%E9%9D%A2%E8%AF%95%E9%A2%98%E6%80%BB%E7%BB%93" target="_blank" rel="noopener noreferrer">webpack 面试题部分<ExternalLinkIcon/></a></p>
<hr>
<h2 id="项目流程" tabindex="-1"><a class="header-anchor" href="#项目流程" aria-hidden="true">#</a> 项目流程</h2>
<h4 id="项目角色" tabindex="-1"><a class="header-anchor" href="#项目角色" aria-hidden="true">#</a> 项目角色</h4>
<ul>
<li>PM 产品经理</li>
<li>UE 视觉设计师</li>
<li>FE 前端开发</li>
...
<h4 id="项目流程-1" tabindex="-1"><a class="header-anchor" href="#项目流程-1" aria-hidden="true">#</a> 项目流程</h4>
<p><img src="https://gitee.com/l544402029/res/raw/master/小书匠/1586443524013.png" alt="项目流程"></p>
<h4 id="评审项目需求时需要注意哪些事项" tabindex="-1"><a class="header-anchor" href="#评审项目需求时需要注意哪些事项" aria-hidden="true">#</a> 评审项目需求时需要注意哪些事项？</h4>
<ul>
<li>了解背景</li>
<li>质疑需求是否合理</li>
<li>需求是否闭环</li>
</ul>
<p>如常见的点赞功能，我们要开发这个功能。我们要考虑点完赞之后呢？这个点赞功能怎么用起来呢？ 如点赞高低进行排序</p>
<ul>
<li>开发难度如何</li>
<li>是否需要其他支持</li>
<li>不要急于给排期</li>
...
<ol>
<li>
<p>大概预留比自己预估时间多 1/4 的时间。 如预估时间为 4 天。 排期 5 天。预估 1 个月， 排期 35 天左右。</p>
</li>
<li>
<p>另外要考虑是否有并行的工作。如果有并行的任务， 应适当延长排期。</p>
</li>
<li>
<p>要考虑 UE（视觉设计师）的排期。如果还依赖 RD（后端开发）或者 CRD （移动端开发）， 应先确定他们的排期再安排自己的排期。<br>
如果大家的排期没确定，可以给一个工作量。要花几天能够做完。如 3 天做完。至于 2 号到 4 号，还是 4 号到 6 号。 什么时候能确定完成， 要看“上游”什么时候完成工作。</p>
</li>
</ol>
<h4 id="如何做好技术方案设计" tabindex="-1"><a class="header-anchor" href="#如何做好技术方案设计" aria-hidden="true">#</a> 如何做好技术方案设计？</h4>
<ul>
<li>求简， 不过度设计</li>
<li>产出文档</li>
<li>找准设计重点</li>
...
<h4 id="如何保证代码质量" tabindex="-1"><a class="header-anchor" href="#如何保证代码质量" aria-hidden="true">#</a> 如何保证代码质量？</h4>
<ul>
<li>符合开发规范
<ol>
<li>git</li>
...
<h4 id="项目过程中-pm-加需求怎么办" tabindex="-1"><a class="header-anchor" href="#项目过程中-pm-加需求怎么办" aria-hidden="true">#</a> 项目过程中 PM 加需求怎么办？</h4>
...
<p>要尽早的让 UE， PM 介入， review 这些功能。 尽早把问题暴露出来。 而不是等上线后再暴露问题。</p>
<p><strong>加需求怎么办？</strong></p>
<ul>
<li>不能拒绝， 走需求变更流程即可</li>
<li>如果公司有规定，则按规定走</li>
<li>否则， 发起项目组和 leader 的评审， 重新评估排期</li>
</ul>
<p>如果需求变动过小， 不至于再次发起评审。 可发邮件， 微信群等方式通知项目相关人员。</p>
<h4 id="测试" tabindex="-1"><a class="header-anchor" href="#测试" aria-hidden="true">#</a> 测试</h4>
<ul>
<li>提测发邮件， 抄送项目组</li>
<li>测试问题要详细记录</li>
<li>有问题及时沟通</li>
<li>如需特定设备才能复现问题， 让 QA 提供设备</li>
</ul>
<h4 id="上线" tabindex="-1"><a class="header-anchor" href="#上线" aria-hidden="true">#</a> 上线</h4>
<ul>
<li>上线之后及时通知 QA 回归测试</li>
<li>上线之后及时同步给 PM 和 项目组</li>
<li>如有问题，及时回滚。先止损，再排查问题。</li>
</ul>
<h4 id="项目沟通" tabindex="-1"><a class="header-anchor" href="#项目沟通" aria-hidden="true">#</a> 项目沟通</h4>
<ul>
<li>每日进行沟通，有事说事， 无事报平安。</li>
<li>及时识别风险，及时汇报</li>
</ul>
<h2 id="通用问题" tabindex="-1"><a class="header-anchor" href="#通用问题" aria-hidden="true">#</a> 通用问题</h2>
<h4 id="说说你写过最复杂的-js-代码" tabindex="-1"><a class="header-anchor" href="#说说你写过最复杂的-js-代码" aria-hidden="true">#</a> 说说你写过最复杂的 js 代码...</h4>
<h4 id="说说你做过最复杂的项目" tabindex="-1"><a class="header-anchor" href="#说说你做过最复杂的项目" aria-hidden="true">#</a> 说说你做过最复杂的项目</h4>
<h4 id="做一下自我介绍" tabindex="-1"><a class="header-anchor" href="#做一下自我介绍" aria-hidden="true">#</a> 做一下自我介绍</h4>
<div class="custom-container tip">
<p class="custom-container-title">思路</p>
<p>我平时喜欢一些网站，喜欢去看它们的技术原理和技术好玩的点。然后呢我自己喜欢思考，我也愿意去尝试是否有更好的实现方式。
此时谨记要收住不要继续往下说， 后半句等面试官发问， 你都喜欢哪些网站？比如喜欢微信读书，艺龙。。。</p>
</div>
<p>您好， 我叫 ***。有一年的前端开发工作经验。之前主要负责过电商，图片处理等方面的开发工作。 现在比较擅长技术栈有 VUE, jQuery, 平时的话也会写写自己的博客之类的。今天应聘这个岗位主要是对咱们公司的这个业务很感兴趣，这个岗位的职业发展跟我自身规划比较吻合。 希望能够加入进来一起工作。</p>
<h4 id="说说你的职业规划" tabindex="-1"><a class="header-anchor" href="#说说你的职业规划" aria-hidden="true">#</a> 说说你的职业规划</h4>
<p>今年的目标是打算研究 Vue 源码 以及 webpack。然后是读两本书 《CSS世界》《你不知道的JavaScript》，并把自己所理解出来的东西输出到博客。</p>
<p>明年打算研究前端算法，Node.js 。</p>
<p>希望能够在三年内能够成为一名比较成熟的全栈开发工程师，能够多参加一些开源作品。</p>
<h4 id="你的五年内的职业目标是什么" tabindex="-1"><a class="header-anchor" href="#你的五年内的职业目标是什么" aria-hidden="true">#</a> 你的五年内的职业目标是什么？</h4>
<p>我希望自己能成为团队里重要的一份子，多多承担责任，并培养自己的技术能力和沟通技巧，五年内成长为一名成熟的技术主管。</p>
<h4 id="为什么要跳槽" tabindex="-1"><a class="header-anchor" href="#为什么要跳槽" aria-hidden="true">#</a> 为什么要跳槽？</h4>
<p>主要是之前公司的技术栈比较老旧，代码书写，部署流程不规范， 能够成长的空间很有限。</p>
<h4 id="你的缺点" tabindex="-1"><a class="header-anchor" href="#你的缺点" aria-hidden="true">#</a> 你的缺点？</h4>
<p>主要还是对服务端/Node 方面的知识知道的太少， 对知识的掌握不够全面。</p>
<h4 id="你有什么想问的吗" tabindex="-1"><a class="header-anchor" href="#你有什么想问的吗" aria-hidden="true">#</a> 你有什么想问的吗？</h4>
<ul>
<li>现在公司团队有多少人？怎么分工？</li>
<li>公司常用的技术栈是什么？</li>
<li>公司是否有技术分享交流活动？有的话，多久一次呢？</li>
<li>公司试用期多长时间呢？试用期工资多少呢？</li>
<li>公司是否交五险一金？缴纳比例？</li>
<li>公司休息时间是怎么安排呢？大小周？双休？单休？</li>
<li>你觉得我有什么需要改进的地方吗？</li>
<li>有公司级别的学习资源吗？比如电子书订阅或者在线课程？</li>
<li>你们认为和竞品相比有什么优势？</li>
</ul>
<h4 id="你对当前待遇的期望" tabindex="-1"><a class="header-anchor" href="#你对当前待遇的期望" aria-hidden="true">#</a> 你对当前待遇的期望...</h4>
<p>我希望按照咱们公司正常的薪资标准来就可以 , 我更看重能够在咱们公司学习到更多东西.</p>
<h4 id="如果达不到期望-你会如何选择" tabindex="-1"><a class="header-anchor" href="#如果达不到期望-你会如何选择" aria-hidden="true">#</a> 如果达不到期望,你会如何选择?</h4>
<ul>
<li>
<p>我相信公司不会让我失望的。</p>
</li>
<li>
<p>如果达不到期望 , 说明我自身技术水平还达不到咱们公司的要求 , 我会更加努力学习的。</p>
</li>
</ul>
</div></template>
